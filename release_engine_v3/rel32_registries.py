...
_AI_KPI_ROWS: Tuple[Tuple[str, ...], ...] = (
    ...
    ('ai_compliance', 'نسبة الامتثال لـ SDAIA', 'KPI', '≥ 90%',
     'ضوابط مطبقة ÷ ضوابط مطلوبة × 100',
...
_DT_KPI_ROWS: Tuple[Tuple[str, ...], ...] = (
    ...
    ('dga_interoperability', 'قياس نضج التكامل وقابلية التشغيل البيني', 'KPI', '≥ 80%',
     'الخدمات المترابطة ÷ الخدمات المستهدفة × 100',
     'كتالوج خدمات رقمية', 'مدير التحول الرقمي', 'ربع سنوي'),
