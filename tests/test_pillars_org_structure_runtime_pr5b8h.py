...
_AR_GOV_FIRST = (
    ...
    "| 2 | اعتماد مصفوفة المسؤوليات | بناء مصفوفة RACI للحوكمة | "
    "مصفوفة RACI معتمدة |\n"
    "| 3 | إصدار حزمة السياسات | إعداد السياسات وآلية المراجعة الدورية | "
    ...
    "| 2 | حماية نقاط النهاية | نشر EDR على الأجهزة الحرجة | "
    "تقارير التغطية |\n"
    "| 3 | تشفير البيانات | تطبيق التشفير أثناء النقل والتخزين | "
    ...
    "| 2 | دليل الاستجابة | إعداد دليل وتمارين دورية | "
    "دليل معتمد + تقارير التمارين |\n"
    "| 3 | إدارة الثغرات | فحص دوري ومعالجة وفق الأولوية | "
...
_AR_TECH_FIRST = (
    ...
    "| 2 | تدريب الفرق التقنية | برنامج تدريب متقدم لفرق الأمن | "
    "خطة التدريب + سجل الحضور |\n"
    "| 3 | محاكاة الحوادث | تمارين محاكاة دورية للحوادث | "
    "تقارير المحاكاة |\n"
)
...
_EN_GOV_FIRST = (
    ...
    "| 2 | Approve responsibility matrix | Build a RACI matrix for "
    "governance roles | Approved RACI matrix |\n"
    "| 3 | Issue security policy bundle | Author policies and periodic "
    "review procedure | Approved policy bundle |\n\n"
    ...
    "| 2 | Endpoint protection | Deploy EDR on critical endpoints | "
    "Coverage report |\n"
    "| 3 | Data encryption | Encrypt data in transit and at rest | "
    "Coverage report + key inventory |\n\n"
    ...
    "| 2 | Response playbook | Author incident response playbook and "
    "tabletop exercises | Approved playbook + exercise reports |\n"
    "| 3 | Vulnerability management | Periodic scanning and "
    "risk-prioritised remediation | Scan reports + remediation register |\n"
)
...
_EN_TECH_FIRST = (
    ...
    "| 1 | Monitoring capability | Integrate log sources and develop "
    "detection use cases | Use-case catalogue + escalation matrix |\n"
    "| 2 | Response playbook | Author incident response playbook | "
    "Approved playbook |\n"
    "| 3 | Vulnerability management | Periodic scanning and remediation | "
    "Scan reports |\n\n"
    ...
    "| 2 | Technical team training | Advanced training for security teams | "
    "Training plan + attendance log |\n"
    "| 3 | Incident simulation | Periodic incident simulation exercises | "
    "Simulation reports |\n"
)
