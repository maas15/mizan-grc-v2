...
class TestPillarHeadingSequenceContract(unittest.TestCase):
    ...
    def test_repair_accepts_sequential_pillar_headings(self):
        good = (
            ...
            '| 2 | اعتماد السياسات | إصدار حزمة السياسات الأمنية | حزمة معتمدة |\n'
            '| 3 | مصفوفة المسؤوليات | بناء مصفوفة RACI شاملة | مصفوفة معتمدة |\n\n'
            '### الركيزة 2: عمليات SOC\n\n'
            'فقرة سرد طويلة كافية الطول لتمرير عتبة المضمون لأنها تحتوي على '
            'تفاصيل كافية لتجاوز فحص المحتوى الموضوعي.\n\n'
            '| # | المبادرة | الوصف | المخرج المتوقع |\n'
            '|---|---|---|---|\n'
            '| 1 | بناء SOC | إنشاء فريق العمليات | تقرير شهري |\n'
            '| 2 | تكامل المصادر | ربط مصادر السجلات بمنصة SIEM | كتالوج متكامل |\n'
            '| 3 | حالات الاستخدام | تطوير حالات الكشف | كتالوج معتمد |\n\n'
            '### الركيزة 3: الاستجابة للحوادث\n\n'
            'فقرة سرد طويلة كافية الطول لتمرير عتبة المضمون لأنها تحتوي على '
            'تفاصيل كافية لتجاوز فحص المحتوى الموضوعي.\n\n'
            '| # | المبادرة | الوصف | المخرج المتوقع |\n'
            '|---|---|---|---|\n'
            '| 1 | إعداد خطة | إنشاء خطة استجابة | خطة موثقة |\n'
            '| 2 | تمارين دورية | تنفيذ تمارين الطاولة | تقارير التمارين |\n'
            '| 3 | دليل الاستجابة | اعتماد دليل التشغيل | دليل معتمد |\n\n'
            '### الركيزة 4: الامتثال\n\n'
            'فقرة سرد طويلة كافية الطول لتمرير عتبة المضمون لأنها تحتوي على '
            'تفاصيل كافية لتجاوز فحص المحتوى الموضوعي.\n\n'
            '| # | المبادرة | الوصف | المخرج المتوقع |\n'
            '|---|---|---|---|\n'
            '| 1 | تدقيق | إعداد أدلة الامتثال | تقرير امتثال |\n'
            '| 2 | المراجعة الدورية | برنامج مراجعة دورية للضوابط | تقارير دورية |\n'
            '| 3 | إطار التقارير | إعداد التقارير للجهات الرقابية | تقارير معتمدة |\n'
        )
        sections = {'pillars': '## 2. الركائز\n\n(يحتاج إعادة بناء)\n'}
