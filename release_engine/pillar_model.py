...
_PILLAR_CATALOG_AR: Tuple[Tuple[str, Tuple[Tuple[str, str, str], ...]], ...] = (
    ('### حوكمة ونموذج التشغيل', (
        ('سياسات الحوكمة السيبرانية', 'اعتماد السياسات', 'منصة حوكمة معتمدة'),
        ('لجنة حوكمة الأمن', 'ميثاق اللجنة', 'لجنة حوكمة فعّالة'),
        ('مصفوفة RACI', 'توزيع المسؤوليات', 'مصفوفة RACI معتمدة'),
    )),
    ('### الحماية والكشف والاستجابة', (
        ('تشغيل SOC/SIEM', 'تشغيل المركز', 'مركز SOC تشغيلي'),
        ('فريق CSIRT', 'خطط الاستجابة', 'فريق CSIRT جاهز'),
