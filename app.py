    ...
    try:
        ...
        if is_arabic:
            try:
                ...
                # Check for common Arabic font locations
                font_paths = [
                ...
                if not font_registered:
                    # Try to download Amiri font if not found
                    ...
                    if not os.path.exists(amiri_path):
                        try:
                            ...
                            urllib.request.urlretrieve(font_url, amiri_path)
                            print(f"Downloaded Amiri font to {amiri_path}")
                        except Exception as dl_error:
                            print(f"Could not download Amiri font: {dl_error}")
