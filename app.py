...
def repair_table_rows(text):
    ...
    table_col_count = 0
    has_num_col = False
    is_strict_num_col = False   # Only '#', 'م', 'No' — never text values
    next_num = 1
    num_col_names = {'#', 'الرقم', 'م', 'الخطوة', 'Step', 'No', 'No.'}
    strict_num_col_names = {'#', 'م', 'الرقم', 'No', 'No.', 'رقم'}
        ...
        if table_col_count > 0:
            ...
            if s.startswith('|') and s.endswith('|'):
                ...
                if has_num_col and cells and cells[0].replace('.', '').isdigit():
                    ...
                    # Shifted row: item text landed in the # column (AI skipped the row number).
