        ...
        while i < len(lines):
            ...
            if line.startswith('|') and '|' in line[1:]:
                ...
                if table_data:
                    ...
                    # Use Arabic font for Arabic content
                    ...
                    header_style = ParagraphStyle(
                        ...
                        fontName=arabic_font_name if is_arabic else 'Helvetica-Bold',
                        alignment=TA_RIGHT if is_arabic else TA_LEFT
                    )
                    ...
                    for row_idx, row in enumerate(table_data):
                        wrapped_row = []
                        for cell in row:
                            cell_text = process_arabic(str(cell)) if is_arabic else str(cell)
