...
---
#### دليل تقييم المؤشر رقم 1: [اسم المؤشر]
**منهجية التقييم:**
| الخطوة | الإجراء | المسؤول | الأدوات/الموارد | المخرج |
|--------|--------|---------|-----------------|--------|
| 1 | تحديد نطاق القياس وحدوده | [الفريق] | التوثيق | وثيقة النطاق |
| 2 | تحديد مصادر البيانات وطرق الجمع | [الفريق] | [الأدوات] | خطة جمع البيانات |
| 3 | تحديد فترة القياس الأساسية | [الفريق] | التحليلات | فترة الأساس |
| 4 | جمع البيانات والتحقق منها | [الفريق] | [الأدوات] | مجموعة البيانات |
| 5 | حساب قيمة المؤشر باستخدام: [الصيغة] | [الفريق] | جداول/BI | القيمة الحالية |
**قائمة التحقق:** ☐ تحديد النطاق ☐ تحديد المصادر ☐ جمع البيانات ☐ التحقق من الدقة ☐ حساب القيمة

---
#### دليل تقييم المؤشر رقم 2: [اسم المؤشر]
**منهجية التقييم:**
| الخطوة | الإجراء | المسؤول | الأدوات/الموارد | المخرج |
|--------|--------|---------|-----------------|--------|
| 1 | تحديد نطاق القياس وحدوده | [الفريق] | التوثيق | وثيقة النطاق |
...
---
#### دليل تقييم المؤشر رقم 3: [اسم المؤشر]
**منهجية التقييم:**
| الخطوة | الإجراء | المسؤول | الأدوات/الموارد | المخرج |
|--------|--------|---------|-----------------|--------|
| 1 | تحديد نطاق القياس وحدوده | [الفريق] | التوثيق | وثيقة النطاق |
...
يجب أن تتضمن الوثيقة أدلة تنفيذ منفصلة ومفصلة لكل فجوة (الفجوة 1، الفجوة 2، الفجوة 3، الفجوة 4، الفجوة 5).
لا تكتب "كرر" أو "نفس الخطوات" - اكتب جدول تنفيذ كامل لكل فجوة على حدة.
بدون أدلة التنفيذ المنفصلة لكل فجوة، تعتبر الوثيقة غير مكتملة ومرفوضة."""
        else:
...
---
#### KPI #1 Assessment Guide: [KPI Name]
**Assessment Methodology:**
| Step | Action | Responsible | Tools/Resources | Output |
|------|--------|-------------|-----------------|--------|
| 1 | Define measurement scope and boundaries | [Team] | Documentation | Scope document |
| 2 | Identify data sources and collection methods | [Team] | [Tools] | Data collection plan |
| 3 | Establish baseline measurement period | [Team] | Analytics | Baseline period |
| 4 | Collect and validate data | [Team] | [Tools] | Raw data set |
| 5 | Calculate KPI value using formula: [Formula] | [Team] | Spreadsheet/BI | Current value |
**Data Collection Checklist:** ☐ Define scope ☐ Identify sources ☐ Collect data ☐ Validate accuracy ☐ Calculate value

---
#### KPI #2 Assessment Guide: [KPI Name]
**Assessment Methodology:**
| Step | Action | Responsible | Tools/Resources | Output |
|------|--------|-------------|-----------------|--------|
| 1 | Define measurement scope and boundaries | [Team] | Documentation | Scope document |
...
---
#### KPI #3 Assessment Guide: [KPI Name]
**Assessment Methodology:**
| Step | Action | Responsible | Tools/Resources | Output |
|------|--------|-------------|-----------------|--------|
| 1 | Define measurement scope and boundaries | [Team] | Documentation | Scope document |
