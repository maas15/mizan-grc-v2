...
- كل قيمة مستهدفة يجب أن تكون مدعومة بسبب واضح (وفقاً للإطار المحدد من المستخدم)
...
⚠️ مهم جداً: لكل مؤشر أداء أعلاه، قدم دليل تقييم خطوة بخطوة لمساعدة المنظمة في قياس القيم الحالية.
...
- Every target value MUST include a clear rationale (e.g. "99.9% per industry SLA standards" or "aligned with selected framework requirements")
...
⚠️ CRITICAL: For EACH KPI above, provide step-by-step assessment guidelines to help the organization measure current values.
