...
⚠️ تعليمات التنسيق للعربية (مهم جداً):
1. استخدم شرطة (-) بدلاً من النقطة (•) للقوائم
2. للقوائم المرقمة اكتب الرقم ثم نقطة ثم مسافة: "1. النص"
3. الجداول يجب أن تبدأ وتنتهي بـ |
4. لا تستخدم تواريخ محددة - استخدم "خلال 30 يوم"

⚠️ تعليمات المحتوى:
1. أنشئ ملاحظات تدقيق حقيقية بناءً على إطار {framework}
2. استخدم رموز ضوابط حقيقية من {framework}
3. لا تكتب قوالب - اكتب محتوى فعلي
...
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | (ملاحظة حقيقية) | (رمز من {framework}) | (التوصية) | يحتاج تقييم |
