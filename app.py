...
def api_generate_pdf():
    ...
    try:
        ...
        def process_arabic(text):
            ...
            Uses arabic_reshaper for letter joining/connecting only.
            Does NOT use get_display (bidi visual reorder) because:
            - ReportLab Paragraph with wordWrap='RTL' handles line wrapping
            - PDF viewers (Adobe, Chrome, etc.) handle BiDi text rendering natively
            - get_display + multi-line wrap = jumbled word order
            """
                    ...
                    if '<b>' in text or '</b>' in text:
                        ...
                        for part in parts:
                            if part in ('<b>', '</b>'):
                                ...
                                processed_parts.append(reshaped)
                            else:
                                processed_parts.append(part)
