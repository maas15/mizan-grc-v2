...
def generate_strategy_simulation(language='en'):
    ...
    if language == 'ar':
        return """## 1. الرؤية والأهداف الاستراتيجية

**الرؤية:**
تأسيس المنظمة كنموذج للتميز في الأمن السيبراني في القطاع الحكومي، وتحقيق الامتثال الكامل للإطار التنظيمي المعتمد مع ضمان أعلى معايير الحوكمة وحماية الأصول الرقمية.

### الأهداف الاستراتيجية:
| # | الهدف | المؤشر المستهدف | المبرر | الإطار الزمني |
|---|-------|----------------|--------|---------------|
| 1 | تحقيق الامتثال الكامل للإطار التنظيمي المعتمد | امتثال > 95% | متطلب أساسي من الإطار التنظيمي | خلال 12 شهر |
| 2 | تعزيز قدرات الكشف والاستجابة | تقليل وقت الاستجابة 50% | ضوابط الكشف والاستجابة في الإطار | خلال 18 شهر |
| 3 | تطوير برنامج توعية شامل | تغطية 100% من الموظفين | متطلبات التوعية والتدريب | خلال 6 أشهر |
| 4 | تنفيذ تقنيات أمنية متقدمة | نشر SIEM و EDR | ضوابط الحماية التقنية | خلال 12 شهر |
| 5 | إنشاء فريق استجابة مركزي | فريق عمل 24/7 | متطلبات إدارة الحوادث | خلال 9 أشهر |
...
|---|--------|---------------|-----------------|---------------|
| 1 | نسبة الامتثال للإطار التنظيمي المعتمد | يُحدد بعد التقييم | > 95% | خلال 12 شهر |
| 2 | وقت الاستجابة للحوادث | يُحدد بعد التقييم | < 1 ساعة | خلال 12 شهر |
| 3 | معدل إكمال التدريب | يُحدد بعد التقييم | > 90% | خلال 6 أشهر |
| 4 | تقليل الحوادث الناجحة | يُحدد بعد التقييم | تقليل 40% | خلال 18 شهر |
| 5 | معدل نجاح التدقيق | يُحدد بعد التقييم | > 95% | خلال 12 شهر |
| 6 | تشفير البيانات الحساسة | يُحدد بعد التقييم | 100% | خلال 12 شهر |
| 7 | تغطية MFA | يُحدد بعد التقييم | 100% | خلال 6 أشهر |
| 8 | تقليل الإيجابيات الكاذبة | يُحدد بعد التقييم | تقليل 50% | خلال 18 شهر |

[SECTION]

## 6. تقييم الثقة والمخاطر

**درجة الثقة:** يُحدد بعد التقييم الميداني
...
|---|-----|---------------|--------------|-----------|
| 1 | Compliance rate | To be assessed | > 95% | Within 12 months |
| 2 | Incident response time | To be assessed | < 1 hour | Within 12 months |
| 3 | Training completion rate | To be assessed | > 90% | Within 6 months |
| 4 | Successful attack reduction | To be assessed | 40% reduction | Within 18 months |
| 5 | Audit pass rate | To be assessed | > 95% | Within 12 months |
| 6 | Sensitive data encryption | To be assessed | 100% | Within 12 months |
| 7 | MFA coverage | To be assessed | 100% | Within 6 months |
| 8 | False positive reduction | To be assessed | 50% reduction | Within 18 months |

[SECTION]

## 6. Confidence Assessment & Risks

**Confidence Score:** To be determined after baseline assessment
...
أنشئ وثيقة استراتيجية احترافية لمجال **{domain_desc}** وفق إطار **{frameworks_list}**.
...
- الإطار المحدد هو: {frameworks_list}
- يجب الإشارة إلى {frameworks_list} بالاسم في الرؤية والأهداف والركائز والمؤشرات
- لا تذكر أي إطار آخر مثل ISO أو NIST أو COBIT إلا إذا كان مذكوراً في القائمة أعلاه
- اربط كل هدف وكل ركيزة بمتطلبات محددة من {frameworks_list}
...
**الرؤية الاستراتيجية:**
(فقرة تصف الرؤية مع ذكر إطار {frameworks_list} صراحةً وكيف ستحقق المنظمة الامتثال له)

### الأهداف الاستراتيجية:
| # | الهدف الاستراتيجي | المؤشر المستهدف | المبرر (مرتبط بـ {frameworks_list}) | الإطار الزمني |
|---|-------------------|-----------------|-------------------------------------|---------------|
(5 أهداف مع ربط كل هدف بمتطلب محدد من {frameworks_list})
...
### مؤشرات الأداء:
| # | المؤشر | الوصف | القيمة الحالية | القيمة المستهدفة | المبرر (مرتبط بـ {frameworks_list}) | الإطار الزمني | مصدر البيانات |
|---|--------|-------|----------------|------------------|-------------------------------------|---------------|---------------|
...
|---|--------|-------|---------|
(5 عوامل نجاح مرتبطة بمتطلبات {frameworks_list})
...
This strategy must be entirely focused on {domain}. Do NOT mix with other domains.
...
You MUST provide a SEPARATE, COMPLETE implementation guide for EACH gap identified above. Do NOT write "repeat" or "same as above" - write the ACTUAL steps for each gap.
