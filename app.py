...
def ensure_markdown_formatting(text):
    ...
    # e.g., "Risks ******Confidence Score: 78%" → proper bold on new line
    text = re.sub(r'\*{3,}(Confidence Score|درجة الثقة)\s*:?\s*(\d+%?)', r'\n\n**\1:** \2', text)
    text = re.sub(r'\*{3,}(Score Justification|مبررات التقييم)', r'\n\n**\1**', text)
