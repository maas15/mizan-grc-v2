...
RISK_CATEGORIES = {
    "cyber": {
        ...
        "ar": {
            ...
            "أمن النقاط الطرفية": ["إصابة بالبرمجيات الخبيثة", "استغلال ثغرة يوم الصفر (Zero-Day)", "هجوم USB", "حصان طروادة", "التعدين الخبيث"],
...
def profile_page():
    ...
    return render_template('profile.html',
                          ...
                          ai_prefs={'generate': ai_pref_generate, 'review': ai_pref_review},
                          domains=txt['domains'])
