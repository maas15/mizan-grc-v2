...
def domain_page(domain_name):
    ...
    grc_domain_relevance = {
        ...
        'data': ['grc_pdpl', 'grc_gdpr'],
        'ai': ['grc_eu_regulations'],
        'dt': ['grc_iso27001', 'grc_nist_csf'],
        'global': ['grc_iso27001', 'grc_gdpr', 'grc_eu_regulations', 'grc_coso_erm', 'grc_fundamentals'],
        'erm': ['grc_coso_erm', 'grc_sama_framework']
    }
