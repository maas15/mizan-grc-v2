...
def domain_page(domain_name):
    ...
    grc_domain_relevance = {
        'cyber': ['grc_nca_frameworks', 'grc_iso27001', 'grc_nist_csf', 'grc_sama_framework', 'grc_eu_regulations', 'grc_pdpl', 'grc_coso_erm'],
        'data': ['grc_pdpl', 'grc_gdpr', 'grc_nca_frameworks', 'grc_eu_regulations', 'grc_iso27001', 'grc_nist_csf', 'grc_sama_framework'],
        'ai': ['grc_eu_regulations', 'grc_nist_csf', 'grc_iso27001', 'grc_nca_frameworks', 'grc_pdpl', 'grc_gdpr', 'grc_coso_erm'],
        'dt': ['grc_nist_csf', 'grc_iso27001', 'grc_coso_erm', 'grc_eu_regulations', 'grc_nca_frameworks', 'grc_sama_framework'],
        'global': ['grc_iso27001', 'grc_nist_csf', 'grc_coso_erm', 'grc_gdpr', 'grc_eu_regulations', 'grc_nca_frameworks', 'grc_pdpl', 'grc_sama_framework'],
        'erm': ['grc_coso_erm', 'grc_nist_csf', 'grc_iso27001', 'grc_sama_framework', 'grc_nca_frameworks', 'grc_eu_regulations']
    }
...
Populate with the ACTUAL data from your strategy above. This block is machine-parsed and will be stripped from display."""
        ...
        def inject_implementation_guidelines(gaps_content, lang_code):
            ...
            if lang_code == 'ar':
                ...
                if existing_full_guides >= len(gaps_list[:5]):
