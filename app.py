...
قواعد صارمة:
- المحتوى خاص بمجال {domain} فقط ومرتبط بإطار {frameworks_list} حصراً
...
- يجب تضمين جميع الأقسام الستة كاملة بدون استثناء

## 1. الرؤية والأهداف

**الرؤية الاستراتيجية:**
(فقرة تصف الرؤية الاستراتيجية لمجال {domain} مع ربطها بإطار {frameworks_list})

### الأهداف الاستراتيجية:
| # | الهدف الاستراتيجي | المؤشر المستهدف | الإطار الزمني |
|---|-------------------|-----------------|---------------|
(5 أهداف في جدول)
