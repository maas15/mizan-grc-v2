...
def domain_page(domain_name):
    ...
    grc_domain_relevance = {
        'cyber': ['grc_nca_frameworks', 'grc_iso27001', 'grc_nist_csf', 'grc_sama_framework', 'grc_incident_bcm'],
        'data': ['grc_pdpl', 'grc_gdpr', 'grc_ndmo'],
        'ai': ['grc_eu_regulations', 'grc_sdaia_ai', 'grc_nist_ai_rmf', 'grc_iso42001'],
        'dt': ['grc_iso27001', 'grc_nist_csf', 'grc_cobit_itil'],
        'global': ['grc_iso27001', 'grc_gdpr', 'grc_eu_regulations', 'grc_coso_erm', 'grc_fundamentals', 'grc_sox_pci'],
        'erm': ['grc_coso_erm', 'grc_sama_framework', 'grc_iso31000']
    }
