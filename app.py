    ...
    domain_system_prompts = {
        'en': {
            ...
            'Data Management': (
                ...
                "Do NOT suggest Cybersecurity Department structures, CISOs, SOCs, or any cybersecurity "
                "organizational gaps. If organizational structure is needed, recommend a Data Management Office "
                "(DMO) with CDO, Data Stewards, and Data Quality roles."
            ),
            'Artificial Intelligence': (
                ...
                "Do NOT suggest general cybersecurity organizational gaps as the primary fix. "
                "If organizational structure is needed, recommend an AI Governance Committee or AI Ethics Office "
                "with AI Ethics Officer, Model Risk, and AI Compliance roles."
            ),
            'Digital Transformation': (
                ...
                "Do NOT reference cybersecurity department structures or CISO roles."
            ),
            'Enterprise Risk Management': (
                ...
                "and organizational resilience. Do NOT reference cybersecurity-specific structures."
            ),
            'Global Standards': (
        ...
        'ar': {
            ...
            'Data Management': (
                ...
                "لا تقترح هياكل إدارة الأمن السيبراني أو مناصب CISO أو SOC. "
                "إذا كان الهيكل التنظيمي مطلوباً، اقترح مكتب إدارة البيانات (DMO) مع مدير البيانات CDO "
                "وأمناء البيانات وفريق جودة البيانات."
            ),
            'Artificial Intelligence': (
                ...
                "لا تقترح فجوات الأمن السيبراني التنظيمية كحل أساسي. "
                "إذا كان الهيكل التنظيمي مطلوباً، اقترح لجنة حوكمة AI أو مكتب أخلاقيات AI."
            ),
            'Digital Transformation': (
...
{"تنبيه حاسم: الهيكل التنظيمي الحالي لا يتضمن إدارة مختصة. يجب أن يكون الهدف الأول في الاستراتيجية هو إنشاء " + {'Cyber Security': 'إدارة أو قسم مختص بالأمن السيبراني. يجب أن تتضمن الركيزة الأولى تفاصيل الهيكل المقترح (مدير الأمن السيبراني، فريق العمليات SOC، فريق الحوكمة، فريق الاستجابة CSIRT) مع تحديد الصلاحيات وخطوط التقارير.', 'Data Management': 'مكتب إدارة البيانات. يجب أن تتضمن الركيزة الأولى تفاصيل الهيكل المقترح (مدير البيانات CDO، أمناء البيانات، فريق جودة البيانات، فريق حوكمة البيانات) مع تحديد الصلاحيات وخطوط التقارير.', 'Artificial Intelligence': 'لجنة أو مكتب حوكمة الذكاء الاصطناعي. يجب أن تتضمن الركيزة الأولى تفاصيل الهيكل المقترح (مسؤول أخلاقيات AI، فريق مخاطر النماذج، فريق امتثال AI) مع تحديد الصلاحيات وخطوط التقارير.', 'Digital Transformation': 'مكتب أو فريق للتحول الرقمي. يجب أن تتضمن الركيزة الأولى تفاصيل الهيكل المقترح (مدير التحول الرقمي، فريق الابتكار، فريق إدارة التغيير) مع تحديد الصلاحيات وخطوط التقارير.', 'Enterprise Risk Management': 'إدارة مختصة بالمخاطر المؤسسية. يجب أن تتضمن الركيزة الأولى تفاصيل الهيكل المقترح (مدير المخاطر CRO، محللو المخاطر، ملاك المخاطر) مع تحديد الصلاحيات وخطوط التقارير.', 'Global Standards': 'إدارة مختصة بالامتثال والمعايير. يجب أن تتضمن الركيزة الأولى تفاصيل الهيكل المقترح (مدير الامتثال، منسقو المعايير، فريق التدقيق) مع تحديد الصلاحيات وخطوط التقارير.'}.get(domain, 'الإدارة المختصة مع تفاصيل الهيكل المقترح وتحديد الصلاحيات وخطوط التقارير.') + " هذا هو الأساس الذي تُبنى عليه جميع الأهداف الأخرى." if org_structure and ('no' in org_structure.lower() or 'لا' in org_structure or 'not' in org_structure.lower() or 'none' in org_structure.lower()) else ""}
...
{"5. CRITICAL: The organization has NO dedicated " + {'Cyber Security': 'cybersecurity department. Objective #1 = Establish a dedicated cybersecurity department (CISO, SOC, Governance, CSIRT) with reporting lines and authority.', 'Data Management': 'data management office. Objective #1 = Establish a dedicated data management office (CDO, Data Stewards, Data Quality, Data Governance) with reporting lines and authority.', 'Artificial Intelligence': 'AI governance structure. Objective #1 = Establish a dedicated AI governance committee/office (AI Ethics Officer, Model Risk, AI Compliance) with reporting lines and authority.', 'Digital Transformation': 'digital transformation office. Objective #1 = Establish a dedicated digital transformation office (CDO/CTO, Innovation, Change Management) with reporting lines and authority.', 'Enterprise Risk Management': 'risk management department. Objective #1 = Establish a dedicated ERM department (CRO, Risk Analysts, Risk Owners) with reporting lines and authority.', 'Global Standards': 'compliance department. Objective #1 = Establish a dedicated compliance department (CCO, Standards Liaisons, Audit Coordinators) with reporting lines and authority.'}.get(domain, 'department for this domain. Objective #1 = Establish the dedicated organizational structure.') + " This is the FOUNDATION before any other objective can succeed." if org_structure and ('no' in org_structure.lower() or 'none' in org_structure.lower()) else ""}
...
### Pillar 1: [Name — e.g., Governance & Risk Management]
• Initiative: [concrete action with a deliverable — e.g., "Establish a GRC steering committee with quarterly reviews"]
• Initiative: [concrete action]
• Initiative: [concrete action]

### Pillar 2: [Name — e.g., Technology & Architecture]
• Initiative: [concrete action]
• Initiative: [concrete action]
• Initiative: [concrete action]

### Pillar 3: [Name — e.g., People & Culture]
• Initiative: [concrete action]
• Initiative: [concrete action]
• Initiative: [concrete action]

### Pillar 4: [Name — e.g., Compliance & Assurance]
• Initiative: [concrete action]
• Initiative: [concrete action]
• Initiative: [concrete action]
...
**Preparation Date:** To be determined"""
        ...
        def identify_section(text, lang_code):
            ...
            if num_match:
                ...
                return {'1': 'vision', '2': 'gaps', '3': 'pillars', '4': 'roadmap', '5': 'kpis', '6': 'confidence'}.get(num)
...
"""
        ...
        log_action(session['user_id'], 'analyze_risk', {'domain': data.get('domain'), 'category': data.get('category'), 'language': lang})
