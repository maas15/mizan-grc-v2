...
def api_generate_pdf():
    ...
    try:
        ...
        def process_arabic(text, font_name_for_wrap=None, font_size_for_wrap=11):
            ...
            if is_arabic and text:
                try:
                    ...
                    # Step 2: Manual word-wrap based on font metrics
                    ...
                    # Step 3: Join with <br/> for ReportLab Paragraph
                    if len(lines) > 1:
        ...
        while i < len(lines):
            ...
            if line.startswith('#### '):
                ...
                raw_text = line[2:]
                text = process_arabic(raw_text, arabic_font_name, 11) if is_arabic else raw_text
                if is_arabic:
