...
POLICY_TEMPLATES = {
    "en": {
        "Information Security Policy": {
            ...
            "framework": "ISO 27001",
            "sections": ["Purpose", "Scope", "Policy Statements", "Roles & Responsibilities", "Compliance", "Review"]
        },
        "Data Protection Policy": {
            "description": "Policy for handling personal and sensitive data in compliance with PDPL and GDPR",
            "framework": "PDPL/GDPR",
            "sections": ["Purpose", "Data Classification", "Processing Principles", "Rights Management", "Breach Response"]
        },
        "Access Control Policy": {
            "description": "Policy governing user access, authentication, and authorization controls",
            "framework": "NCA ECC",
            "sections": ["Purpose", "Access Principles", "User Management", "Authentication", "Monitoring"]
        },
        "Incident Response Policy": {
            "description": "Policy for detecting, responding to, and recovering from security incidents",
            "framework": "NIST CSF",
            "sections": ["Purpose", "Incident Classification", "Response Procedures", "Communication", "Recovery"]
        },
        "Business Continuity Policy": {
            "description": "Policy ensuring business operations continue during disruptions",
            "framework": "ISO 22301",
            "sections": ["Purpose", "BIA Requirements", "Recovery Strategies", "Testing", "Maintenance"]
        },
        "Acceptable Use Policy": {
            "description": "Policy defining acceptable use of IT resources and systems",
            "framework": "General",
            "sections": ["Purpose", "Acceptable Use", "Prohibited Activities", "Monitoring", "Violations"]
        },
        "Cloud Security Policy": {
            "description": "Policy for secure use of cloud services and infrastructure",
            "framework": "NCA CCC",
            "sections": ["Purpose", "Cloud Governance", "Security Controls", "Data Protection", "Vendor Management"]
        },
        "Third Party Risk Policy": {
            "description": "Policy for managing risks from vendors and third parties",
            "framework": "ISO 27001",
            "sections": ["Purpose", "Vendor Assessment", "Contract Requirements", "Monitoring", "Termination"]
        }
    },
    "ar": {
        "سياسة أمن المعلومات": {
            ...
            "framework": "ISO 27001",
            "sections": ["الغرض", "النطاق", "بنود السياسة", "الأدوار والمسؤوليات", "الامتثال", "المراجعة"]
        },
        "سياسة حماية البيانات": {
            "description": "سياسة للتعامل مع البيانات الشخصية والحساسة وفقاً لنظام حماية البيانات",
            "framework": "PDPL",
            "sections": ["الغرض", "تصنيف البيانات", "مبادئ المعالجة", "إدارة الحقوق", "الاستجابة للانتهاكات"]
        },
        "سياسة التحكم بالوصول": {
            "description": "سياسة تحكم وصول المستخدمين والمصادقة والتفويض",
            "framework": "NCA ECC",
            "sections": ["الغرض", "مبادئ الوصول", "إدارة المستخدمين", "المصادقة", "المراقبة"]
        },
        "سياسة الاستجابة للحوادث": {
            "description": "سياسة لاكتشاف الحوادث الأمنية والاستجابة لها والتعافي منها",
            "framework": "NIST CSF",
            "sections": ["الغرض", "تصنيف الحوادث", "إجراءات الاستجابة", "التواصل", "التعافي"]
        },
        "سياسة استمرارية الأعمال": {
            "description": "سياسة لضمان استمرار العمليات أثناء الاضطرابات",
            "framework": "ISO 22301",
            "sections": ["الغرض", "متطلبات تحليل الأثر", "استراتيجيات التعافي", "الاختبار", "الصيانة"]
        },
        "سياسة الاستخدام المقبول": {
            "description": "سياسة تحدد الاستخدام المقبول لموارد تقنية المعلومات",
            "framework": "عام",
            "sections": ["الغرض", "الاستخدام المقبول", "الأنشطة المحظورة", "المراقبة", "المخالفات"]
        },
        "سياسة أمن السحابة": {
            "description": "سياسة للاستخدام الآمن للخدمات والبنية التحتية السحابية",
            "framework": "NCA CCC",
            "sections": ["الغرض", "حوكمة السحابة", "الضوابط الأمنية", "حماية البيانات", "إدارة الموردين"]
        },
        "سياسة مخاطر الأطراف الثالثة": {
            "description": "سياسة لإدارة المخاطر من الموردين والأطراف الثالثة",
            "framework": "ISO 27001",
            "sections": ["الغرض", "تقييم الموردين", "متطلبات العقود", "المراقبة", "الإنهاء"]
        }
    }
}
...
STRATEGY_TEMPLATES = {
    "en": {
        "Cybersecurity Strategy": {
            "description": "Comprehensive cybersecurity strategy aligned with NCA frameworks",
            "focus": ["Risk Management", "Security Operations", "Incident Response", "Compliance"],
            "horizon": "36 months"
        },
        "Digital Transformation Strategy": {
            "description": "Strategy for organizational digital transformation initiatives",
            "focus": ["Technology Modernization", "Process Automation", "Digital Services", "Change Management"],
            "horizon": "48 months"
        },
        "Data Governance Strategy": {
            "description": "Strategy for enterprise data management and governance",
            "focus": ["Data Quality", "Data Protection", "Analytics", "Compliance"],
            "horizon": "24 months"
        },
        "AI Governance Strategy": {
            "description": "Strategy for responsible AI adoption and governance",
            "focus": ["AI Ethics", "Model Governance", "Risk Management", "Compliance"],
            "horizon": "36 months"
        }
    },
    "ar": {
        "استراتيجية الأمن السيبراني": {
            "description": "استراتيجية شاملة للأمن السيبراني متوافقة مع أطر الهيئة الوطنية",
            "focus": ["إدارة المخاطر", "العمليات الأمنية", "الاستجابة للحوادث", "الامتثال"],
            "horizon": "36 شهر"
        },
        "استراتيجية التحول الرقمي": {
            "description": "استراتيجية لمبادرات التحول الرقمي المؤسسي",
            "focus": ["تحديث التقنية", "أتمتة العمليات", "الخدمات الرقمية", "إدارة التغيير"],
            "horizon": "48 شهر"
        },
        "استراتيجية حوكمة البيانات": {
            "description": "استراتيجية لإدارة وحوكمة بيانات المؤسسة",
            "focus": ["جودة البيانات", "حماية البيانات", "التحليلات", "الامتثال"],
            "horizon": "24 شهر"
        },
        "استراتيجية حوكمة الذكاء الاصطناعي": {
            "description": "استراتيجية للتبني المسؤول وحوكمة الذكاء الاصطناعي",
            "focus": ["أخلاقيات الذكاء الاصطناعي", "حوكمة النماذج", "إدارة المخاطر", "الامتثال"],
            "horizon": "36 شهر"
        }
    }
}
...
AUDIT_TEMPLATES = {
    "en": {
        ...
        "NCA ECC Compliance Audit": {
            ...
            "controls": 114,
            "domains": ["Governance", "Defense", "Resilience", "Third Party", "ICS"]
        },
        "PDPL Compliance Audit": {
            "description": "Audit for Personal Data Protection Law compliance",
            "controls": 45,
            "domains": ["Lawfulness", "Rights", "Security", "Transfer", "Breach Response"]
        },
        "Cloud Security Audit": {
            "description": "Audit for cloud infrastructure and services security",
            "controls": 80,
            "domains": ["Governance", "IAM", "Data Protection", "Network", "Logging"]
        }
    },
    "ar": {
        "تدقيق الامتثال ISO 27001": {
            "description": "قائمة تدقيق لنظام إدارة أمن المعلومات ISO 27001",
            "controls": 114,
            "domains": ["السياق", "القيادة", "التخطيط", "الدعم", "التشغيل", "التقييم", "التحسين"]
        },
        "تدقيق الامتثال NCA ECC": {
            "description": "تدقيق وفق ضوابط الأمن السيبراني الأساسية للهيئة الوطنية",
            "controls": 114,
            "domains": ["الحوكمة", "الدفاع", "المرونة", "الأطراف الثالثة", "الأنظمة الصناعية"]
        },
        "تدقيق الامتثال لنظام حماية البيانات": {
            "description": "تدقيق للامتثال لنظام حماية البيانات الشخصية",
            "controls": 45,
            "domains": ["المشروعية", "الحقوق", "الأمان", "النقل", "الاستجابة للانتهاكات"]
        },
        "تدقيق أمن السحابة": {
            "description": "تدقيق لأمن البنية التحتية والخدمات السحابية",
            "controls": 80,
            "domains": ["الحوكمة", "إدارة الهوية", "حماية البيانات", "الشبكة", "السجلات"]
        }
    }
}
...
RISK_TEMPLATES = {
    "en": {
        "Enterprise Risk Register": {
            "description": "Comprehensive risk register template for enterprise-wide risks",
            "categories": ["Strategic", "Operational", "Financial", "Compliance", "Technology"]
        },
        "Cybersecurity Risk Assessment": {
            "description": "Risk assessment focused on cyber threats and vulnerabilities",
            "categories": ["External Threats", "Internal Threats", "Technical", "Human", "Physical"]
        },
        "Third Party Risk Assessment": {
            "description": "Risk assessment for vendors and third-party relationships",
            "categories": ["Security", "Privacy", "Compliance", "Operational", "Financial"]
        },
        "Cloud Risk Assessment": {
            "description": "Risk assessment for cloud services and infrastructure",
            "categories": ["Data Security", "Access Control", "Availability", "Compliance", "Vendor Lock-in"]
        }
    },
    "ar": {
        "سجل المخاطر المؤسسية": {
            "description": "قالب شامل لسجل المخاطر على مستوى المؤسسة",
            "categories": ["استراتيجية", "تشغيلية", "مالية", "امتثال", "تقنية"]
        },
        "تقييم مخاطر الأمن السيبراني": {
            "description": "تقييم مخاطر يركز على التهديدات والثغرات السيبرانية",
            "categories": ["تهديدات خارجية", "تهديدات داخلية", "تقنية", "بشرية", "مادية"]
        },
        "تقييم مخاطر الأطراف الثالثة": {
            "description": "تقييم مخاطر للموردين وعلاقات الأطراف الثالثة",
            "categories": ["الأمان", "الخصوصية", "الامتثال", "التشغيل", "المالية"]
        },
        "تقييم مخاطر السحابة": {
            "description": "تقييم مخاطر للخدمات والبنية التحتية السحابية",
            "categories": ["أمن البيانات", "التحكم بالوصول", "التوفر", "الامتثال", "الارتباط بالمورد"]
        }
    }
}
...
def calculate_compliance_score(user_id):
    ...
    # Max expected: 5 strategies, 10 policies, 5 audits, 10 risks, 5 domains
    strategy_score = min(strategies / 5, 1) * 20  # 20%
    policy_score = min(policies / 10, 1) * 25     # 25%
    audit_score = min(audits / 5, 1) * 25         # 25%
...
def api_get_templates(template_type):
    ...
    templates = templates_map.get(template_type, {}).get(lang, {})
        ...
        while i < len(lines):
            ...
            if line.startswith('|') and '|' in line[1:]:
                ...
                if table_data:
                    ...
                    # First column (usually #) is narrow, last column (usually description) is wider
                    if col_count >= 4:
                        # For tables with 4+ columns, make first column narrow, others flexible
                        first_col = 0.4 * inch
                        remaining = doc.width - first_col
                        other_cols = remaining / (col_count - 1)
                        col_widths = [first_col] + [other_cols] * (col_count - 1)
                    elif col_count == 3:
                        col_widths = [0.5*inch, 2.5*inch, 2.5*inch]
                    elif col_count == 2:
                        col_widths = [2*inch, doc.width - 2*inch]
                    else:
                    ...
                    header_style = ParagraphStyle('HeaderStyle', fontSize=9, leading=11, textColor=colors.white)
