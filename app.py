...
⚠️⚠️⚠️ معلومات حرجة - اقرأ بعناية ⚠️⚠️⚠️
المجال المستهدف: **{domain}**
الأطر التنظيمية المختارة من المستخدم: **{frameworks_list}**
اسم المنظمة: {data.get('org_name', 'المنظمة')}
القطاع: {data.get('sector', 'حكومي')}

مهمتك: إنشاء وثيقة استراتيجية شاملة واحترافية مكونة من 6 أقسام كاملة.

⚠️⚠️⚠️ مهم جداً - فاصل الأقسام ⚠️⚠️⚠️
يجب وضع النص [SECTION] بين كل قسم وآخر. هذا ضروري جداً لعمل النظام.
مثال:
## 1. الرؤية والأهداف
(محتوى القسم الأول)
...
وهكذا لجميع الأقسام الستة.

⚠️ تنبيهات حاسمة:
1. استخدم فقط الأطر المختارة أعلاه ({frameworks_list}). لا تذكر أي إطار آخر مثل ISO أو NIST ما لم يكن في القائمة.
2. يجب كتابة جميع الأقسام الستة كاملة - لا تحذف أي قسم.
3. لا تستخدم تواريخ محددة - استخدم أطر زمنية نسبية (خلال 6 أشهر، السنة الأولى).
4. القيم الحالية = "يُحدد من قبل المنظمة". فقط القيم المستهدفة يمكن تحديدها مع مبرر.
5. ⚠️ ضع [SECTION] بين كل قسم - هذا إلزامي.
...
قواعد التنسيق:
- ابدأ كل قسم رئيسي بـ ## (مثال: ## 1. الرؤية والأهداف)
- استخدم ### قبل كل جدول
- الجداول بتنسيق Markdown: كل صف يبدأ وينتهي بـ |
- القوائم النقطية تبدأ بـ •
- ⚠️ ضع [SECTION] بعد نهاية كل قسم

اكتب الأقسام التالية بالترتيب:
...
### الأهداف الاستراتيجية:
| # | الهدف الاستراتيجي | المؤشر المستهدف | الإطار الزمني | الارتباط بالإطار |
|---|-------------------|-----------------|---------------|-----------------|
| 1 | [هدف محدد وقابل للقياس] | [مؤشر كمي واضح] | خلال X شهر | [رمز الضابط] |
| 2 | [هدف محدد وقابل للقياس] | [مؤشر كمي واضح] | خلال X شهر | [رمز الضابط] |
| 3 | [هدف محدد وقابل للقياس] | [مؤشر كمي واضح] | خلال X شهر | [رمز الضابط] |
| 4 | [هدف محدد وقابل للقياس] | [مؤشر كمي واضح] | خلال X شهر | [رمز الضابط] |
| 5 | [هدف محدد وقابل للقياس] | [مؤشر كمي واضح] | خلال X شهر | [رمز الضابط] |
| 6 | [هدف محدد وقابل للقياس] | [مؤشر كمي واضح] | خلال X شهر | [رمز الضابط] |
...
### الفجوات المحددة:
| # | الفجوة | الوصف التفصيلي | الأثر المحتمل | الأولوية | الحالة |
|---|--------|----------------|---------------|----------|--------|
| 1 | [اسم الفجوة] | [وصف شامل للفجوة] | [الأثر على المنظمة] | عالية | يحتاج تقييم |
| 2 | [اسم الفجوة] | [وصف شامل للفجوة] | [الأثر على المنظمة] | عالية | يحتاج تقييم |
| 3 | [اسم الفجوة] | [وصف شامل للفجوة] | [الأثر على المنظمة] | متوسطة | يحتاج تقييم |
| 4 | [اسم الفجوة] | [وصف شامل للفجوة] | [الأثر على المنظمة] | متوسطة | يحتاج تقييم |
| 5 | [اسم الفجوة] | [وصف شامل للفجوة] | [الأثر على المنظمة] | متوسطة | يحتاج تقييم |

### أدلة التنفيذ التفصيلية:

⚠️ مهم جداً: يجب تقديم دليل تنفيذ منفصل ومفصل لكل فجوة من الفجوات المحددة أعلاه. لا تكتب "كرر" أو "نفس الخطوات" - اكتب الخطوات الفعلية لكل فجوة.

---
#### دليل تنفيذ الفجوة رقم 1: [اسم الفجوة الأولى]
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | [خطوة محددة للفجوة 1] | [الجهة] | [المخرج] |
| التخطيط | 1.2 | [خطوة محددة للفجوة 1] | [الجهة] | [المخرج] |
| التنفيذ | 2.1 | [خطوة محددة للفجوة 1] | [الجهة] | [المخرج] |
| التنفيذ | 2.2 | [خطوة محددة للفجوة 1] | [الجهة] | [المخرج] |
| التحقق | 3.1 | [خطوة محددة للفجوة 1] | [الجهة] | [المخرج] |
**الأدلة المطلوبة:** ☐ [دليل 1] ☐ [دليل 2] ☐ [دليل 3]

---
#### دليل تنفيذ الفجوة رقم 2: [اسم الفجوة الثانية]
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | [خطوة محددة للفجوة 2] | [الجهة] | [المخرج] |
| التخطيط | 1.2 | [خطوة محددة للفجوة 2] | [الجهة] | [المخرج] |
| التنفيذ | 2.1 | [خطوة محددة للفجوة 2] | [الجهة] | [المخرج] |
| التنفيذ | 2.2 | [خطوة محددة للفجوة 2] | [الجهة] | [المخرج] |
| التحقق | 3.1 | [خطوة محددة للفجوة 2] | [الجهة] | [المخرج] |
**الأدلة المطلوبة:** ☐ [دليل 1] ☐ [دليل 2] ☐ [دليل 3]

---
#### دليل تنفيذ الفجوة رقم 3: [اسم الفجوة الثالثة]
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | [خطوة محددة للفجوة 3] | [الجهة] | [المخرج] |
| التخطيط | 1.2 | [خطوة محددة للفجوة 3] | [الجهة] | [المخرج] |
| التنفيذ | 2.1 | [خطوة محددة للفجوة 3] | [الجهة] | [المخرج] |
| التنفيذ | 2.2 | [خطوة محددة للفجوة 3] | [الجهة] | [المخرج] |
| التحقق | 3.1 | [خطوة محددة للفجوة 3] | [الجهة] | [المخرج] |
**الأدلة المطلوبة:** ☐ [دليل 1] ☐ [دليل 2] ☐ [دليل 3]

---
#### دليل تنفيذ الفجوة رقم 4: [اسم الفجوة الرابعة]
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | [خطوة محددة للفجوة 4] | [الجهة] | [المخرج] |
| التخطيط | 1.2 | [خطوة محددة للفجوة 4] | [الجهة] | [المخرج] |
| التنفيذ | 2.1 | [خطوة محددة للفجوة 4] | [الجهة] | [المخرج] |
| التنفيذ | 2.2 | [خطوة محددة للفجوة 4] | [الجهة] | [المخرج] |
| التحقق | 3.1 | [خطوة محددة للفجوة 4] | [الجهة] | [المخرج] |
**الأدلة المطلوبة:** ☐ [دليل 1] ☐ [دليل 2] ☐ [دليل 3]

---
#### دليل تنفيذ الفجوة رقم 5: [اسم الفجوة الخامسة]
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | [خطوة محددة للفجوة 5] | [الجهة] | [المخرج] |
| التخطيط | 1.2 | [خطوة محددة للفجوة 5] | [الجهة] | [المخرج] |
| التنفيذ | 2.1 | [خطوة محددة للفجوة 5] | [الجهة] | [المخرج] |
| التنفيذ | 2.2 | [خطوة محددة للفجوة 5] | [الجهة] | [المخرج] |
| التحقق | 3.1 | [خطوة محددة للفجوة 5] | [الجهة] | [المخرج] |
**الأدلة المطلوبة:** ☐ [دليل 1] ☐ [دليل 2] ☐ [دليل 3]
...
|---|--------|---------|--------|----------|
| 1 | [نشاط تأسيسي] | [الجهة] | شهر 1-2 | [المخرج] |
| 2 | [نشاط تأسيسي] | [الجهة] | شهر 2-3 | [المخرج] |
| 3 | [نشاط تأسيسي] | [الجهة] | شهر 3-4 | [المخرج] |
| 4 | [نشاط تأسيسي] | [الجهة] | شهر 4-6 | [المخرج] |

### المرحلة 2: البناء (6-12 شهر)
| # | النشاط | المسؤول | الموعد | المخرجات |
|---|--------|---------|--------|----------|
| 1 | [نشاط بناء] | [الجهة] | شهر 6-7 | [المخرج] |
| 2 | [نشاط بناء] | [الجهة] | شهر 7-9 | [المخرج] |
| 3 | [نشاط بناء] | [الجهة] | شهر 9-10 | [المخرج] |
| 4 | [نشاط بناء] | [الجهة] | شهر 10-12 | [المخرج] |

### المرحلة 3: التحسين والنضج (12-24 شهر)
| # | النشاط | المسؤول | الموعد | المخرجات |
|---|--------|---------|--------|----------|
| 1 | [نشاط تحسين] | [الجهة] | شهر 12-15 | [المخرج] |
| 2 | [نشاط تحسين] | [الجهة] | شهر 15-18 | [المخرج] |
| 3 | [نشاط تحسين] | [الجهة] | شهر 18-21 | [المخرج] |
| 4 | [نشاط تحسين] | [الجهة] | شهر 21-24 | [المخرج] |
...
|---|--------|-------|---------------|-----------------|--------|---------------|--------------|
| 1 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 2 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 3 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 4 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 5 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 6 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 7 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |
| 8 | [اسم المؤشر] | [وصف موجز] | يُحدد من قبل المنظمة | [قيمة مبررة] | [سبب اختيار القيمة] | خلال X شهر | [المصدر] |

### أدلة تقييم مؤشرات الأداء

قدم أدلة تقييم لكل مؤشر أداء:

---
#### دليل تقييم المؤشر رقم 1: [اسم المؤشر الأول]
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | تحديد نطاق القياس | [الفريق] | وثيقة النطاق |
| 2 | تحديد مصادر البيانات | [الفريق] | قائمة المصادر |
| 3 | جمع بيانات الأساس | [الفريق] | البيانات الخام |
| 4 | التحقق من دقة البيانات | [الفريق] | بيانات موثقة |
| 5 | حساب القيمة الحالية | [الفريق] | قيمة المؤشر |
...
|---|-------|-----------|-------|-------------------|
| 1 | [الخطر الأول] | عالية/متوسطة | عالي/متوسط | [الإجراء] |
| 2 | [الخطر الثاني] | عالية/متوسطة | عالي/متوسط | [الإجراء] |
| 3 | [الخطر الثالث] | عالية/متوسطة | عالي/متوسط | [الإجراء] |
| 4 | [الخطر الرابع] | عالية/متوسطة | عالي/متوسط | [الإجراء] |

---
**تاريخ الإعداد:** [سيتم إضافته]
**المُعد:** فريق الحوكمة والمخاطر والامتثال

⚠️⚠️⚠️ تأكد من كتابة جميع الأقسام الستة كاملة ⚠️⚠️⚠️
يجب أن تتضمن الوثيقة:
1. ## 1. الرؤية والأهداف - مع جدول الأهداف الاستراتيجية
2. ## 2. تحليل الفجوات - مع جدول الفجوات وأدلة التنفيذ لكل فجوة
3. ## 3. الركائز الاستراتيجية - مع 4 ركائز ومبادراتها
4. ## 4. خارطة الطريق - مع 3 مراحل وجداول الأنشطة
5. ## 5. مؤشرات الأداء الرئيسية - مع جدول 8 مؤشرات وأدلة تقييم
6. ## 6. تقييم الثقة والمخاطر - مع درجة الثقة وجدول المخاطر

لا تحذف أي قسم. كل قسم مطلوب."""
        else:
...
Include the Confidence Score section with justified scoring."""
        ...
        if lang == 'ar':
            prompt = f"""أنت مدقق خبير في الحوكمة والمخاطر والامتثال. أنشئ تقرير تدقيق شامل ومفصل بتنسيق Markdown.

⚠️⚠️⚠️ معلومات التدقيق ⚠️⚠️⚠️
الإطار التنظيمي: **{framework}**
نطاق التدقيق: {audit_scope}
المجال: {domain}
وثائق الإثبات: {', '.join(evidence_info) if evidence_info else 'لم يتم تقديم أدلة'}

⚠️ تعليمات حاسمة:
1. أنشئ ملاحظات تدقيق حقيقية ومحددة بناءً على إطار {framework}
2. لا تكتب قوالب أو علامات مثل [الملاحظة] - اكتب ملاحظات فعلية
3. استخدم رموز ضوابط حقيقية من إطار {framework}
4. لا تستخدم تواريخ محددة - استخدم "خلال 30 يوم" أو "خلال 60 يوم"
5. القوائم المرقمة: 1. ثم 2. ثم 3.
6. القوائم النقطية تبدأ بـ •

أنشئ التقرير بالتنسيق التالي:

# تقرير التدقيق - {framework}

## الملخص التنفيذي
اكتب ملخصاً تنفيذياً يتضمن نسبة الامتثال الإجمالية والنتائج الرئيسية.
...
### نتائج عالية الخطورة
اكتب ملاحظتين على الأقل عالية الخطورة مع ضوابط حقيقية من {framework}:
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | (اكتب ملاحظة حقيقية مثل: عدم وجود سياسة تصنيف البيانات) | (رمز ضابط من {framework}) | (التوصية المحددة) | يحتاج تقييم |
| 2 | (ملاحظة حقيقية أخرى) | (رمز ضابط) | (التوصية) | يحتاج تقييم |

### نتائج متوسطة الخطورة
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | (ملاحظة متوسطة الخطورة) | (رمز ضابط) | (التوصية) | يحتاج تقييم |
| 2 | (ملاحظة أخرى) | (رمز ضابط) | (التوصية) | يحتاج تقييم |

### نتائج منخفضة الخطورة
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | (ملاحظة منخفضة الخطورة) | (رمز ضابط) | (التوصية) | يحتاج تقييم |

## أدلة التنفيذ التفصيلية

اكتب دليل تنفيذ لكل ملاحظة عالية ومتوسطة الخطورة:

---
### دليل تنفيذ الملاحظة عالية الخطورة رقم 1
**الضابط المتأثر:** (نفس الرمز من الجدول أعلاه)
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | (خطوة محددة) | (الفريق المسؤول) | (المخرج المتوقع) |
| التخطيط | 1.2 | (خطوة أخرى) | (الفريق) | (المخرج) |
| التنفيذ | 2.1 | (خطوة التنفيذ) | (الفريق) | (المخرج) |
| التنفيذ | 2.2 | (خطوة أخرى) | (الفريق) | (المخرج) |
| التحقق | 3.1 | (خطوة التحقق) | (الفريق) | (المخرج) |
**الأدلة المطلوبة:** ☐ (دليل 1) ☐ (دليل 2) ☐ (دليل 3)
...
| المجال | نسبة الامتثال | التقييم |
|--------|--------------|---------|
| الحوكمة والقيادة | (نسبة)% | (ملاحظة) |
| إدارة المخاطر | (نسبة)% | (ملاحظة) |
| الضوابط التقنية | (نسبة)% | (ملاحظة) |
| التوعية والتدريب | (نسبة)% | (ملاحظة) |

## خطة العمل
| # | الإجراء | المسؤول | الموعد النهائي | الأولوية |
|---|--------|---------|---------------|----------|
| 1 | (إجراء محدد) | (الفريق) | خلال 30 يوم | عالية |
| 2 | (إجراء آخر) | (الفريق) | خلال 60 يوم | متوسطة |
| 3 | (إجراء ثالث) | (الفريق) | خلال 90 يوم | منخفضة |
...
| العامل | الوزن | الدرجة | المبرر |
|--------|-------|--------|--------|
| جودة الأدلة | 25% | (X/10) | (تقييم) |
| تغطية الضوابط | 25% | (X/10) | (تقييم) |
| مراجعة التوثيق | 20% | (X/10) | (تقييم) |
| موثوقية المقابلات | 15% | (X/10) | (تقييم) |
| كفاية العينة | 15% | (X/10) | (تقييم) |

**تفسير مستوى الثقة:**
• 90-100%: ثقة عالية
• 70-89%: ثقة متوسطة
• 50-69%: ثقة محدودة
• أقل من 50%: ثقة منخفضة

---
**تاريخ التقرير:** [سيتم إضافته]
**التدقيق القادم:** خلال 6 أشهر

⚠️ مهم: اكتب محتوى حقيقي ومحدد - لا تكتب قوالب أو علامات."""
