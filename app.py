...
⚠️ مهم جداً: يجب تقديم دليل تنفيذ منفصل للملاحظة رقم 1، والملاحظة رقم 2، إلخ. لا تكتب "كرر" - اكتب الخطوات الفعلية لكل ملاحظة.
...
---
### دليل تنفيذ الملاحظة متوسطة الخطورة رقم 1: [عنوان الملاحظة المتوسطة]
**الضابط المتأثر:** [رمز الضابط]
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | [خطوة محددة لهذه الملاحظة] | [الفريق] | [المخرج] |
...
⚠️⚠️⚠️ تذكير نهائي مهم جداً ⚠️⚠️⚠️
يجب تقديم أدلة تنفيذ منفصلة لكل ملاحظة عالية ومتوسطة الخطورة.
لا تكتب "كرر لكل ملاحظة" - اكتب جدول التنفيذ الفعلي لكل ملاحظة على حدة.
يجب تضمين قسم درجة الثقة مع التبرير."""
