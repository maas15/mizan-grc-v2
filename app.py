...
| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
(Generate 5 rows: Planning 1.1, Planning 1.2, Execution 2.1, Execution 2.2, Verification 3.1. UNIQUE steps for this specific gap — do NOT copy from other gaps. NO empty cells.)
**Evidence Required:** ☐ (list 3 specific evidence items for this gap)
...
|---|-----|-------------|---------------|--------------|---------------|-----------|-------------|
(Generate 8 rows. Current Value = "To be assessed" for all. Each KPI must measure at CONTROL DOMAIN level with justified target, timeframe, and data source. NO empty cells.)
