...
|---|--------|---------------|-----------------|---------------|
| 1 | نسبة الامتثال الشامل لإطار {fw} | يُحدد بعد التقييم | > 95% | خلال 12 شهر |
| 2 | متوسط وقت الكشف والاستجابة للحوادث (MTTD/MTTR) | يُحدد بعد التقييم | MTTD < 4 ساعات، MTTR < 24 ساعة | خلال 12 شهر |
| 3 | معدل إكمال التدريب على التوعية الأمنية | يُحدد بعد التقييم | > 90% | خلال 6 أشهر |
| 4 | معالجة الثغرات ضمن الإطار الزمني المحدد | يُحدد بعد التقييم | > 85% خلال 30 يوم | خلال 12 شهر |
| 5 | نسبة تطبيق ضوابط إدارة الهوية والوصول | يُحدد بعد التقييم | 100% | خلال 9 أشهر |
| 6 | نسبة تطبيق الضوابط التقنية وفق {fw} | يُحدد بعد التقييم | 100% | خلال 12 شهر |
| 7 | اختبار خطط استمرارية الأعمال | يُحدد بعد التقييم | اختباران سنوياً | خلال 12 شهر |
| 8 | نسبة امتثال الأطراف الثالثة أمنياً | يُحدد بعد التقييم | 100% مقيّمة | خلال 18 شهر |
...
|---|-----|---------------|--------------|-----------|
| 1 | {fw} overall compliance rate | To be assessed | > 95% | Within 12 months |
| 2 | Mean time to detect and respond to incidents (MTTD/MTTR) | To be assessed | MTTD < 4hrs, MTTR < 24hrs | Within 12 months |
| 3 | Security awareness training completion rate | To be assessed | > 90% | Within 6 months |
| 4 | Vulnerability remediation within SLA | To be assessed | > 85% within 30 days | Within 12 months |
| 5 | Identity & access management controls implementation | To be assessed | 100% | Within 9 months |
| 6 | {fw} technical controls implementation rate | To be assessed | 100% | Within 12 months |
| 7 | Business continuity plan testing completion | To be assessed | 2 tests/year | Within 12 months |
| 8 | Third-party/vendor security compliance rate | To be assessed | 100% assessed | Within 18 months |
