...
|---|--------|-------|----------|--------|
| 1 | فجوة السياسات | الحاجة لتحديث السياسات لتتوافق مع المتطلبات التنظيمية | عالية | يحتاج تقييم |
| 2 | فجوة التقنية | نقص في أدوات SIEM و EDR ومراقبة الشبكة | عالية | يحتاج تقييم |
| 3 | فجوة التدريب | برامج توعية غير كافية للموظفين | متوسطة | يحتاج تقييم |
| 4 | فجوة الاستجابة | خطة استجابة للحوادث غير مكتملة | عالية | يحتاج تقييم |
| 5 | فجوة البيانات | ضوابط حماية البيانات تحتاج تعزيز | متوسطة | يحتاج تقييم |

> 📋 **ملاحظة:** راجع أدلة التنفيذ التفصيلية لكل فجوة أدناه للحصول على خطوات العمل الميدانية.

---

### دليل تنفيذ الفجوة رقم 1: فجوة السياسات

**الخطوات التفصيلية:**

| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | جرد جميع السياسات الحالية | أمن المعلومات | قائمة السياسات |
| التخطيط | 1.2 | تحديد المتطلبات التنظيمية (NCA, PDPL) | الامتثال | جدول المتطلبات |
| التخطيط | 1.3 | تحليل الفجوات بين الوضع الحالي والمطلوب | أمن المعلومات | تقرير الفجوات |
| التنفيذ | 2.1 | صياغة السياسات الجديدة/المحدثة | أمن المعلومات | مسودات السياسات |
| التنفيذ | 2.2 | مراجعة قانونية وتقنية | الشؤون القانونية | تعليقات المراجعة |
| التنفيذ | 2.3 | اعتماد من الإدارة العليا | الإدارة التنفيذية | سياسات معتمدة |
| النشر | 3.1 | تواصل مع الموظفين | التواصل الداخلي | إشعارات رسمية |
| النشر | 3.2 | تدريب على السياسات الجديدة | التدريب | سجلات التدريب |
| المراقبة | 4.1 | مراجعة دورية (كل 6 أشهر) | أمن المعلومات | تقارير المراجعة |

**الأدلة المطلوبة:** ☐ السياسات المعتمدة ☐ سجلات المراجعة ☐ تقارير التدريب

---

### دليل تنفيذ الفجوة رقم 2: فجوة التقنية (SIEM/EDR)

**الخطوات التفصيلية:**

| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | تقييم الاحتياجات التقنية | فريق الأمن | وثيقة المتطلبات |
| التخطيط | 1.2 | دراسة الحلول المتاحة في السوق | تقنية المعلومات | تقرير المقارنة |
| التخطيط | 1.3 | إعداد الميزانية وخطة المشتريات | الإدارة المالية | الميزانية المعتمدة |
| الشراء | 2.1 | طرح المناقصة واختيار المورد | المشتريات | عقد موقع |
| التنفيذ | 3.1 | تجهيز البنية التحتية | فريق البنية التحتية | بيئة جاهزة |
| التنفيذ | 3.2 | تثبيت وتكوين SIEM | فريق الأمن | نظام مُفعّل |
| التنفيذ | 3.3 | دمج مصادر السجلات | تقنية المعلومات | تكامل مكتمل |
| التنفيذ | 3.4 | نشر EDR على نقاط النهاية | فريق الأمن | تغطية كاملة |
| التشغيل | 4.1 | تدريب فريق المراقبة | التدريب | فريق مؤهل |
| التشغيل | 4.2 | إعداد قواعد الكشف والتنبيهات | فريق الأمن | قواعد مُفعّلة |

**الأدلة المطلوبة:** ☐ عقد المورد ☐ تقرير التثبيت ☐ لقطات الشاشة ☐ شهادات التدريب

---

### دليل تنفيذ الفجوة رقم 3: فجوة التدريب
...
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | مراجعة خطة الاستجابة الحالية | فريق الأمن | تقرير الفجوات |
...
### دليل تنفيذ الفجوة رقم 5: فجوة حماية البيانات

**الخطوات التفصيلية:**

| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | جرد البيانات وتصنيفها | إدارة البيانات | سجل البيانات |
| التخطيط | 1.2 | تحديد متطلبات PDPL | الامتثال | قائمة المتطلبات |
| التنفيذ | 2.1 | تطبيق سياسة تصنيف البيانات | أمن المعلومات | بيانات مصنفة |
| التنفيذ | 2.2 | نشر حلول DLP | تقنية المعلومات | DLP مُفعّل |
| التنفيذ | 2.3 | تشفير البيانات الحساسة | فريق الأمن | بيانات مشفرة |
| التنفيذ | 2.4 | تكوين ضوابط الوصول | تقنية المعلومات | صلاحيات محدثة |
| المراقبة | 3.1 | مراقبة حركة البيانات | فريق الأمن | تقارير المراقبة |
| المراقبة | 3.2 | مراجعة الصلاحيات دورياً | أمن المعلومات | تقرير المراجعة |

**الأدلة المطلوبة:** ☐ سجل تصنيف البيانات ☐ تقارير DLP ☐ شهادات التشفير
...
|---|-----|-------------|----------|--------|
| 1 | Policy Gap | Need to update policies to meet regulatory requirements | High | To Be Assessed |
| 2 | Technology Gap | Lack of SIEM, EDR, and network monitoring tools | High | To Be Assessed |
| 3 | Training Gap | Insufficient awareness programs for employees | Medium | To Be Assessed |
| 4 | Response Gap | Incomplete incident response plan | High | To Be Assessed |
| 5 | Data Gap | Data protection controls need strengthening | Medium | To Be Assessed |

> 📋 **Note:** See detailed implementation guides for each gap below for on-the-ground action steps.

---

### Gap #1 Implementation Guide: Policy Gap

**Step-by-Step Implementation:**

| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | Inventory all existing policies | InfoSec | Policy inventory list |
| Planning | 1.2 | Identify regulatory requirements (NCA, PDPL) | Compliance | Requirements matrix |
| Planning | 1.3 | Conduct gap analysis (current vs. required) | InfoSec | Gap report |
| Execution | 2.1 | Draft new/updated policies | InfoSec | Policy drafts |
| Execution | 2.2 | Legal and technical review | Legal Affairs | Review comments |
| Execution | 2.3 | Executive approval | Executive Management | Approved policies |
| Deployment | 3.1 | Communicate to employees | Internal Comms | Official notices |
| Deployment | 3.2 | Training on new policies | Training | Training records |
| Monitoring | 4.1 | Periodic review (every 6 months) | InfoSec | Review reports |

**Evidence Required:** ☐ Approved policies ☐ Review records ☐ Training reports

---

### Gap #2 Implementation Guide: Technology Gap (SIEM/EDR)

**Step-by-Step Implementation:**

| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | Assess technical requirements | Security Team | Requirements document |
| Planning | 1.2 | Research available market solutions | IT | Comparison report |
| Planning | 1.3 | Prepare budget and procurement plan | Finance | Approved budget |
| Procurement | 2.1 | Issue RFP and select vendor | Procurement | Signed contract |
| Implementation | 3.1 | Prepare infrastructure | Infrastructure Team | Ready environment |
| Implementation | 3.2 | Install and configure SIEM | Security Team | Activated system |
| Implementation | 3.3 | Integrate log sources | IT | Complete integration |
| Implementation | 3.4 | Deploy EDR to endpoints | Security Team | Full coverage |
| Operations | 4.1 | Train monitoring team | Training | Qualified team |
| Operations | 4.2 | Configure detection rules and alerts | Security Team | Active rules |

**Evidence Required:** ☐ Vendor contract ☐ Installation report ☐ Screenshots ☐ Training certificates

---

### Gap #3 Implementation Guide: Training Gap
...
| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | Review current response plan | Security Team | Gap report |
...
### Gap #5 Implementation Guide: Data Protection Gap

**Step-by-Step Implementation:**

| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | Inventory and classify data | Data Management | Data register |
| Planning | 1.2 | Identify PDPL requirements | Compliance | Requirements list |
| Implementation | 2.1 | Apply data classification policy | InfoSec | Classified data |
| Implementation | 2.2 | Deploy DLP solutions | IT | Activated DLP |
| Implementation | 2.3 | Encrypt sensitive data | Security Team | Encrypted data |
| Implementation | 2.4 | Configure access controls | IT | Updated permissions |
| Monitoring | 3.1 | Monitor data movement | Security Team | Monitoring reports |
| Monitoring | 3.2 | Periodic permission reviews | InfoSec | Review report |

**Evidence Required:** ☐ Data classification register ☐ DLP reports ☐ Encryption certificates
...
|---|----------|---------------|---------|--------|
| 1 | عدم تفعيل MFA للأنظمة الحساسة | AC-2 | تفعيل فوري للمصادقة متعددة العوامل | يحتاج تقييم |
| 2 | سياسات كلمات المرور ضعيفة | IA-5 | تحديث متطلبات كلمات المرور | يحتاج تقييم |

> 📋 **ملاحظة:** راجع قسم "دليل التنفيذ التفصيلي" أدناه للحصول على خطوات المعالجة الميدانية لكل ملاحظة.

---

## دليل التنفيذ التفصيلي

### الملاحظة رقم 1: عدم تفعيل MFA للأنظمة الحساسة

**الضابط المتأثر:** AC-2 (إدارة الحسابات)

**الخطوات التفصيلية للتنفيذ:**

**المرحلة 1: التخطيط والإعداد (الأسبوع 1-2)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 1.1 | جرد جميع الأنظمة الحساسة والحرجة | فريق تقنية المعلومات | قائمة الأنظمة المستهدفة |
| 1.2 | تحديد المستخدمين الذين يحتاجون MFA | أمن المعلومات | قائمة المستخدمين |
| 1.3 | اختيار حل MFA المناسب (تطبيق، رسالة، مفتاح) | فريق الأمن | وثيقة اختيار الحل |
| 1.4 | إعداد ميزانية وجدول زمني | الإدارة | خطة المشروع المعتمدة |

**المرحلة 2: الإعداد التقني (الأسبوع 3-4)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 2.1 | تثبيت وتكوين خادم MFA | فريق البنية التحتية | خادم جاهز للعمل |
| 2.2 | دمج MFA مع Active Directory | فريق تقنية المعلومات | تكامل ناجح |
| 2.3 | اختبار في بيئة التطوير | فريق الاختبار | تقرير الاختبار |
| 2.4 | إعداد إجراءات الطوارئ (في حال فقدان الجهاز) | أمن المعلومات | إجراء موثق |

**المرحلة 3: النشر والتدريب (الأسبوع 5-6)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 3.1 | تدريب فريق الدعم الفني | التدريب | شهادات التدريب |
| 3.2 | تدريب المستخدمين النهائيين | التدريب | سجلات التدريب |
| 3.3 | نشر تدريجي بدءاً بالمسؤولين | فريق تقنية المعلومات | تقرير النشر |
| 3.4 | نشر شامل لجميع المستخدمين | فريق تقنية المعلومات | اكتمال النشر |

**المرحلة 4: المراقبة والتحسين (مستمر)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 4.1 | مراقبة معدل نجاح التسجيل | أمن المعلومات | تقرير أسبوعي |
| 4.2 | معالجة المشاكل والاستثناءات | فريق الدعم | سجل المشاكل |
| 4.3 | مراجعة وتحديث السياسات | أمن المعلومات | سياسة محدثة |

**الأدلة المطلوبة للإغلاق:**
- [ ] تقرير تفعيل MFA لجميع الأنظمة الحساسة
- [ ] سجلات تدريب المستخدمين
- [ ] تقرير اختبار الاختراق
- [ ] سياسة MFA المعتمدة

---

### الملاحظة رقم 2: سياسات كلمات المرور ضعيفة

**الضابط المتأثر:** IA-5 (إدارة المصادقة)

**الخطوات التفصيلية للتنفيذ:**

**المرحلة 1: التقييم والتخطيط (الأسبوع 1)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 1.1 | مراجعة سياسة كلمات المرور الحالية | أمن المعلومات | تقرير الفجوات |
| 1.2 | مقارنة مع معايير NCA ECC و NIST | أمن المعلومات | جدول المقارنة |
| 1.3 | تحديد المتطلبات الجديدة | فريق الأمن | وثيقة المتطلبات |

**المرحلة 2: تحديث السياسة (الأسبوع 2)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 2.1 | صياغة سياسة كلمات المرور الجديدة | أمن المعلومات | مسودة السياسة |
| 2.2 | مراجعة قانونية وتقنية | الإدارة القانونية + تقنية المعلومات | تعليقات المراجعة |
| 2.3 | اعتماد السياسة من الإدارة العليا | الإدارة التنفيذية | سياسة معتمدة |

**المرحلة 3: التطبيق التقني (الأسبوع 3-4)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 3.1 | تكوين متطلبات الطول (12+ حرف) | فريق تقنية المعلومات | إعدادات محدثة |
| 3.2 | تفعيل متطلبات التعقيد | فريق تقنية المعلومات | إعدادات محدثة |
| 3.3 | تكوين سجل كلمات المرور (آخر 24) | فريق تقنية المعلومات | إعدادات محدثة |
| 3.4 | تفعيل قفل الحساب (5 محاولات) | فريق تقنية المعلومات | إعدادات محدثة |

**المرحلة 4: التواصل والتدريب (الأسبوع 5)**
| الخطوة | الوصف | المسؤول | المخرجات |
|--------|-------|---------|----------|
| 4.1 | إرسال إشعار للموظفين | التواصل الداخلي | إشعار رسمي |
| 4.2 | توفير إرشادات إنشاء كلمات مرور قوية | التدريب | دليل المستخدم |
| 4.3 | فترة سماح لتغيير كلمات المرور | فريق تقنية المعلومات | جدول الفترة |

**الأدلة المطلوبة للإغلاق:**
- [ ] سياسة كلمات المرور المعتمدة
- [ ] لقطات شاشة لإعدادات Group Policy
- [ ] سجل التواصل مع الموظفين
- [ ] تقرير امتثال كلمات المرور
...
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 3 | تأخر في تحديث الأنظمة | SI-2 | تطبيق جدول تحديث منتظم | يحتاج تقييم |
| 4 | نقص في التوثيق | PL-1 | تحديث الوثائق الفنية | يحتاج تقييم |

### نتائج منخفضة الخطورة
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 5 | تدريب غير مكتمل | AT-2 | استكمال برنامج التدريب | يحتاج تقييم |
...
|---|-------------|-----------------|----------------|--------|
| 1 | MFA not enabled for sensitive systems | AC-2 | Immediate MFA implementation | To Be Assessed |
| 2 | Weak password policies | IA-5 | Update password requirements | To Be Assessed |

> 📋 **Note:** See "Detailed Implementation Guidelines" section below for on-the-ground remediation steps for each finding.

---

## Detailed Implementation Guidelines

### Finding #1: MFA Not Enabled for Sensitive Systems

**Affected Control:** AC-2 (Account Management)
...
|------|-------------|-------|-------------|
| 1.1 | Inventory all sensitive and critical systems | IT Team | Target systems list |
| 1.2 | Identify users requiring MFA | InfoSec | User list |
| 1.3 | Select appropriate MFA solution (app, SMS, hardware key) | Security Team | Solution selection document |
| 1.4 | Prepare budget and timeline | Management | Approved project plan |

**Phase 2: Technical Setup (Week 3-4)**
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 2.1 | Install and configure MFA server | Infrastructure Team | Production-ready server |
| 2.2 | Integrate MFA with Active Directory | IT Team | Successful integration |
| 2.3 | Test in development environment | QA Team | Test report |
| 2.4 | Prepare emergency procedures (device loss) | InfoSec | Documented procedure |

**Phase 3: Deployment & Training (Week 5-6)**
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 3.1 | Train helpdesk staff | Training | Training certificates |
| 3.2 | Train end users | Training | Training records |
| 3.3 | Phased rollout starting with administrators | IT Team | Rollout report |
| 3.4 | Full deployment to all users | IT Team | Deployment completion |

**Phase 4: Monitoring & Improvement (Ongoing)**
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 4.1 | Monitor enrollment success rate | InfoSec | Weekly report |
| 4.2 | Address issues and exceptions | Support Team | Issue log |
| 4.3 | Review and update policies | InfoSec | Updated policy |

**Evidence Required for Closure:**
- [ ] MFA activation report for all sensitive systems
...
**Affected Control:** IA-5 (Authenticator Management)
...
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 1.1 | Review current password policy | InfoSec | Gap report |
| 1.2 | Compare with NCA ECC & NIST standards | InfoSec | Comparison matrix |
| 1.3 | Define new requirements | Security Team | Requirements document |

**Phase 2: Policy Update (Week 2)**
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 2.1 | Draft new password policy | InfoSec | Policy draft |
| 2.2 | Legal and technical review | Legal + IT | Review comments |
| 2.3 | Executive approval | Executive Management | Approved policy |

**Phase 3: Technical Implementation (Week 3-4)**
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 3.1 | Configure length requirements (12+ characters) | IT Team | Updated settings |
| 3.2 | Enable complexity requirements | IT Team | Updated settings |
| 3.3 | Configure password history (last 24) | IT Team | Updated settings |
| 3.4 | Enable account lockout (5 attempts) | IT Team | Updated settings |

**Phase 4: Communication & Training (Week 5)**
| Step | Description | Owner | Deliverable |
|------|-------------|-------|-------------|
| 4.1 | Send notification to employees | Internal Comms | Official notice |
| 4.2 | Provide strong password creation guidelines | Training | User guide |
| 4.3 | Grace period for password changes | IT Team | Grace period schedule |

**Evidence Required for Closure:**
- [ ] Approved password policy
- [ ] Group Policy settings screenshots
...
| # | Observation | Affected Control | Recommendation | Status |
|---|-------------|-----------------|----------------|--------|
| 3 | Delayed system updates | SI-2 | Implement regular update schedule | To Be Assessed |
| 4 | Documentation gaps | PL-1 | Update technical documentation | To Be Assessed |

### Low-Risk Findings
| # | Observation | Affected Control | Recommendation | Status |
|---|-------------|-----------------|----------------|--------|
| 5 | Incomplete training | AT-2 | Complete training program | To Be Assessed |
...
| 3 | System updates | Infrastructure Team | Within 45 days | Medium |
...
def generate_risk_simulation(language='en'):
    """Generate risk analysis simulation content with implementation guidelines."""
    if language == 'ar':
...
|---|--------|----------|---------------|-----------------|--------|
| 1 | تفعيل المصادقة متعددة العوامل | عالية | فوري | 50,000 ريال | يحتاج تقييم |
| 2 | تحديث أنظمة الكشف عن التهديدات | عالية | 30 يوم | 200,000 ريال | يحتاج تقييم |
| 3 | تدريب الموظفين على التوعية الأمنية | متوسطة | 60 يوم | 30,000 ريال | يحتاج تقييم |

> 📋 **ملاحظة:** راجع أدلة تنفيذ الضوابط أدناه للحصول على خطوات التطبيق الميدانية.

---

### دليل تنفيذ الضابط رقم 1: المصادقة متعددة العوامل (MFA)

**الخطوات التفصيلية:**

| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التحضير | 1.1 | جرد الأنظمة والحسابات المستهدفة | فريق الأمن | قائمة الأنظمة |
| التحضير | 1.2 | اختيار حل MFA المناسب | تقنية المعلومات | وثيقة الاختيار |
| التحضير | 1.3 | إعداد خطة الطرح | مدير المشروع | خطة معتمدة |
| التنفيذ | 2.1 | تثبيت وتكوين خدمة MFA | فريق البنية التحتية | خدمة جاهزة |
| التنفيذ | 2.2 | ربط MFA مع Active Directory | تقنية المعلومات | تكامل ناجح |
| التنفيذ | 2.3 | اختبار مع مجموعة تجريبية | فريق الاختبار | تقرير الاختبار |
| الطرح | 3.1 | تدريب فريق الدعم الفني | التدريب | فريق جاهز |
| الطرح | 3.2 | إرسال تعليمات للمستخدمين | التواصل الداخلي | إشعار رسمي |
| الطرح | 3.3 | تفعيل تدريجي للأقسام | تقنية المعلومات | تقرير التفعيل |
| المراقبة | 4.1 | مراقبة معدل التبني | فريق الأمن | تقرير أسبوعي |

**الأدلة المطلوبة:** ☐ تقارير التفعيل ☐ سجلات التدريب ☐ لقطات الشاشة

---

### دليل تنفيذ الضابط رقم 2: أنظمة الكشف عن التهديدات

**الخطوات التفصيلية:**

| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | تقييم الأنظمة الحالية وتحديد الفجوات | فريق الأمن | تقرير التقييم |
| التخطيط | 1.2 | تحديد متطلبات SIEM/EDR | أمن المعلومات | وثيقة المتطلبات |
| الشراء | 2.1 | مقارنة الحلول المتاحة | تقنية المعلومات | تقرير المقارنة |
| الشراء | 2.2 | اختيار المورد وتوقيع العقد | المشتريات | عقد موقع |
| التنفيذ | 3.1 | تجهيز البيئة التقنية | فريق البنية التحتية | بيئة جاهزة |
| التنفيذ | 3.2 | تثبيت وتكوين النظام | المورد + فريق الأمن | نظام مُفعّل |
| التنفيذ | 3.3 | دمج مصادر السجلات | تقنية المعلومات | مصادر مدمجة |
| التشغيل | 4.1 | إنشاء قواعد الكشف والتنبيهات | فريق الأمن | قواعد فعالة |
| التشغيل | 4.2 | تدريب فريق SOC | التدريب | فريق مؤهل |
| التشغيل | 4.3 | ضبط التنبيهات لتقليل الإيجابيات الكاذبة | فريق الأمن | تنبيهات دقيقة |

**الأدلة المطلوبة:** ☐ عقد المورد ☐ تقرير التثبيت ☐ قائمة مصادر السجلات ☐ شهادات التدريب

---

### دليل تنفيذ الضابط رقم 3: التوعية الأمنية

**الخطوات التفصيلية:**

| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | تقييم مستوى الوعي الحالي | أمن المعلومات | استبيان أساسي |
| التخطيط | 1.2 | تحديد المواضيع الرئيسية | فريق الأمن | خطة المحتوى |
| التطوير | 2.1 | إنشاء مواد تدريبية تفاعلية | التدريب | محتوى جاهز |
| التطوير | 2.2 | إعداد سيناريوهات محاكاة التصيد | فريق الأمن | سيناريوهات جاهزة |
| التنفيذ | 3.1 | إطلاق التدريب الإلزامي | الموارد البشرية | جدول التدريب |
| التنفيذ | 3.2 | تنفيذ حملة محاكاة التصيد الأولى | فريق الأمن | تقرير النتائج |
| التنفيذ | 3.3 | تصحيح السلوكيات وتدريب إضافي | التدريب | جلسات مركزة |
| المراقبة | 4.1 | قياس معدل الإكمال والنجاح | التدريب | لوحة متابعة |
| المراقبة | 4.2 | مقارنة نتائج المحاكاة عبر الزمن | فريق الأمن | تقرير التحسن |

**الأدلة المطلوبة:** ☐ سجلات التدريب ☐ نتائج المحاكاة ☐ تقارير التحسن
...
|---|---------|----------|----------|----------------|--------|
| 1 | Enable Multi-Factor Authentication | High | Immediate | $15,000 | To Be Assessed |
| 2 | Update Threat Detection Systems | High | 30 days | $50,000 | To Be Assessed |
| 3 | Employee Security Awareness Training | Medium | 60 days | $10,000 | To Be Assessed |

> 📋 **Note:** See control implementation guides below for on-the-ground deployment steps.

---

### Control #1 Implementation Guide: Multi-Factor Authentication (MFA)

**Step-by-Step Implementation:**

| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Preparation | 1.1 | Inventory target systems and accounts | Security Team | Systems list |
| Preparation | 1.2 | Select appropriate MFA solution | IT | Selection document |
| Preparation | 1.3 | Develop rollout plan | Project Manager | Approved plan |
| Implementation | 2.1 | Install and configure MFA service | Infrastructure Team | Ready service |
| Implementation | 2.2 | Integrate MFA with Active Directory | IT | Successful integration |
| Implementation | 2.3 | Test with pilot group | QA Team | Test report |
| Deployment | 3.1 | Train helpdesk staff | Training | Ready team |
| Deployment | 3.2 | Send instructions to users | Internal Comms | Official notice |
| Deployment | 3.3 | Gradual department-by-department activation | IT | Activation report |
| Monitoring | 4.1 | Monitor adoption rate | Security Team | Weekly report |

**Evidence Required:** ☐ Activation reports ☐ Training records ☐ Screenshots

---

### Control #2 Implementation Guide: Threat Detection Systems

**Step-by-Step Implementation:**

| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | Assess current systems and identify gaps | Security Team | Assessment report |
| Planning | 1.2 | Define SIEM/EDR requirements | InfoSec | Requirements document |
| Procurement | 2.1 | Compare available solutions | IT | Comparison report |
| Procurement | 2.2 | Select vendor and sign contract | Procurement | Signed contract |
| Implementation | 3.1 | Prepare technical environment | Infrastructure Team | Ready environment |
| Implementation | 3.2 | Install and configure system | Vendor + Security Team | Activated system |
| Implementation | 3.3 | Integrate log sources | IT | Integrated sources |
| Operations | 4.1 | Create detection rules and alerts | Security Team | Active rules |
| Operations | 4.2 | Train SOC team | Training | Qualified team |
| Operations | 4.3 | Tune alerts to reduce false positives | Security Team | Accurate alerts |

**Evidence Required:** ☐ Vendor contract ☐ Installation report ☐ Log source list ☐ Training certificates

---

### Control #3 Implementation Guide: Security Awareness Training

**Step-by-Step Implementation:**

| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | Assess current awareness level | InfoSec | Baseline survey |
| Planning | 1.2 | Identify key topics | Security Team | Content plan |
| Development | 2.1 | Create interactive training materials | Training | Ready content |
| Development | 2.2 | Prepare phishing simulation scenarios | Security Team | Ready scenarios |
| Execution | 3.1 | Launch mandatory training | HR | Training schedule |
| Execution | 3.2 | Execute first phishing simulation campaign | Security Team | Results report |
| Execution | 3.3 | Remediate behaviors with additional training | Training | Focused sessions |
| Monitoring | 4.1 | Measure completion and pass rates | Training | Tracking dashboard |
| Monitoring | 4.2 | Compare simulation results over time | Security Team | Improvement report |

**Evidence Required:** ☐ Training records ☐ Simulation results ☐ Improvement reports
...
def api_generate_strategy():
    ...
    try:
        ...
        if lang == 'ar':
            ...
            prompt = f"""أنشئ وثيقة استراتيجية احترافية لمجال {domain} وفق إطار {frameworks_list}.

المنظمة: {data.get('org_name', 'المنظمة')}
القطاع: {data.get('sector', 'حكومي')}

قواعد صارمة:
- لا تكتب أي تعليمات في المخرجات (مثل "اكتب" أو "لكل فجوة")
- لا تستخدم أي نسب مئوية (لا 75% ولا 80% ولا أي رقم%)
- القيم الحالية = "يُحدد لاحقاً"
- استخدم [SECTION] بين الأقسام

## 1. الرؤية والأهداف

**الرؤية الاستراتيجية:**
(فقرة وصفية عن رؤية المنظمة)

### الأهداف الاستراتيجية:
| # | الهدف | المؤشر | الإطار الزمني |
|---|-------|--------|---------------|
| 1 | تطوير إطار حوكمة شامل | معدل تغطية الضوابط | خلال 6 أشهر |
| 2 | تعزيز الوعي الأمني | نسبة إتمام التدريب | خلال 12 شهر |
| 3 | تحسين إدارة المخاطر | عدد المخاطر المعالجة | خلال 9 أشهر |
| 4 | رفع مستوى الامتثال | تقييم الامتثال الدوري | خلال 12 شهر |
| 5 | تطوير القدرات التقنية | جاهزية البنية التحتية | خلال 18 شهر |
...
| # | الفجوة | الوصف | الأولوية | الحالة |
|---|--------|-------|---------|--------|
| 1 | غياب سياسة تصنيف البيانات | عدم وجود سياسة معتمدة لتصنيف البيانات حسب مستوى الحساسية | عالية | يحتاج تقييم |
| 2 | ضعف برنامج التوعية الأمنية | عدم كفاية برامج التدريب والتوعية للموظفين | عالية | يحتاج تقييم |
| 3 | نقص في إدارة الهويات والصلاحيات | عدم تطبيق مبدأ الحد الأدنى من الصلاحيات | متوسطة | يحتاج تقييم |
| 4 | ضعف آليات المراقبة والكشف | محدودية قدرات الكشف عن التهديدات | متوسطة | يحتاج تقييم |
| 5 | عدم اكتمال خطة استمرارية الأعمال | نقص في اختبار وتحديث خطط الاستمرارية | منخفضة | يحتاج تقييم |

### دليل تنفيذ الفجوة رقم 1: غياب سياسة تصنيف البيانات
| المرحلة | الخطوة | الوصف | المسؤول | المخرج |
|---------|--------|-------|---------|--------|
| التخطيط | 1.1 | جرد أصول البيانات وتحديد أنواعها | فريق البيانات | قائمة أصول البيانات |
| التخطيط | 1.2 | تحديد مستويات التصنيف المطلوبة | فريق الأمن | مصفوفة التصنيف |
| التنفيذ | 2.1 | صياغة سياسة التصنيف | فريق الحوكمة | مسودة السياسة |
| التنفيذ | 2.2 | اعتماد ونشر السياسة | الإدارة العليا | سياسة معتمدة |
| التحقق | 3.1 | تدريب الموظفين والتحقق من التطبيق | فريق التدريب | سجلات التدريب |

### دليل تنفيذ الفجوة رقم 2: ضعف برنامج التوعية الأمنية
| المرحلة | الخطوة | الوصف | المسؤول | المخرج |
|---------|--------|-------|---------|--------|
| التخطيط | 1.1 | تقييم مستوى الوعي الحالي | فريق التدريب | تقرير التقييم |
| التخطيط | 1.2 | تصميم برنامج توعية شامل | فريق التدريب | خطة البرنامج |
| التنفيذ | 2.1 | تطوير المحتوى التدريبي | فريق المحتوى | مواد تدريبية |
| التنفيذ | 2.2 | تنفيذ جلسات التدريب | فريق التدريب | سجلات الحضور |
| التحقق | 3.1 | قياس فعالية البرنامج | فريق الجودة | تقرير الفعالية |

### دليل تنفيذ الفجوة رقم 3: نقص في إدارة الهويات والصلاحيات
| المرحلة | الخطوة | الوصف | المسؤول | المخرج |
|---------|--------|-------|---------|--------|
| التخطيط | 1.1 | مراجعة الصلاحيات الحالية | فريق الأمن | تقرير المراجعة |
| التخطيط | 1.2 | تحديد متطلبات IAM | الفريق التقني | وثيقة المتطلبات |
| التنفيذ | 2.1 | تطبيق مبدأ الحد الأدنى | فريق العمليات | صلاحيات محدثة |
| التنفيذ | 2.2 | تفعيل المصادقة متعددة العوامل | الفريق التقني | MFA مفعل |
| التحقق | 3.1 | تدقيق الصلاحيات دورياً | فريق التدقيق | تقرير التدقيق |

### دليل تنفيذ الفجوة رقم 4: ضعف آليات المراقبة والكشف
| المرحلة | الخطوة | الوصف | المسؤول | المخرج |
|---------|--------|-------|---------|--------|
| التخطيط | 1.1 | تقييم قدرات المراقبة الحالية | فريق الأمن | تقرير التقييم |
| التخطيط | 1.2 | تحديد متطلبات SIEM/SOC | الفريق التقني | وثيقة المتطلبات |
| التنفيذ | 2.1 | نشر أدوات المراقبة | فريق البنية التحتية | أدوات منشورة |
| التنفيذ | 2.2 | تكوين قواعد الكشف | فريق الأمن | قواعد مفعلة |
| التحقق | 3.1 | اختبار فعالية الكشف | فريق الاختبار | تقرير الاختبار |

### دليل تنفيذ الفجوة رقم 5: عدم اكتمال خطة استمرارية الأعمال
| المرحلة | الخطوة | الوصف | المسؤول | المخرج |
|---------|--------|-------|---------|--------|
| التخطيط | 1.1 | تحليل تأثير الأعمال | فريق BCP | تقرير BIA |
| التخطيط | 1.2 | تحديد الأنظمة الحرجة | فريق تقنية المعلومات | قائمة الأنظمة |
| التنفيذ | 2.1 | تطوير خطط الاستمرارية | فريق BCP | خطط محدثة |
| التنفيذ | 2.2 | إعداد بيئة التعافي | الفريق التقني | بيئة جاهزة |
| التحقق | 3.1 | تنفيذ تمارين المحاكاة | فريق BCP | تقرير التمرين |
...
**الهدف:** تعزيز إطار الحوكمة المؤسسية
- تطوير هيكل حوكمة واضح
- إنشاء لجنة توجيهية
- تحديث السياسات والإجراءات

### الركيزة 2: إدارة المخاطر
**الهدف:** تطبيق إطار متكامل لإدارة المخاطر
- تنفيذ منهجية تقييم المخاطر
- تطوير سجل مخاطر مركزي
- تعزيز قدرات الاستجابة

### الركيزة 3: الضوابط التقنية
**الهدف:** تحديث وتعزيز البنية التحتية
- نشر حلول أمنية متقدمة
- تعزيز حماية الهوية والوصول
- تطبيق أدوات المراقبة

### الركيزة 4: الكفاءات والثقافة
**الهدف:** بناء ثقافة أمنية مستدامة
- تنفيذ برنامج توعية شامل
...
| # | النشاط | المسؤول | الموعد | المخرج |
|---|--------|---------|--------|--------|
| 1 | إعداد خطة المشروع | مدير المشروع | شهر 1-2 | خطة معتمدة |
| 2 | تقييم الوضع الراهن | فريق التقييم | شهر 2-3 | تقرير التقييم |
| 3 | تطوير السياسات | فريق الحوكمة | شهر 3-5 | السياسات المعتمدة |
| 4 | إطلاق برنامج التوعية | فريق التدريب | شهر 4-6 | برنامج فعال |

### المرحلة 2: البناء (6-12 شهر)
| # | النشاط | المسؤول | الموعد | المخرج |
|---|--------|---------|--------|--------|
| 1 | تنفيذ الضوابط التقنية | الفريق التقني | شهر 6-8 | ضوابط مطبقة |
| 2 | بناء قدرات الفريق | فريق التدريب | شهر 7-9 | فريق مؤهل |
| 3 | تطوير آليات المراقبة | فريق العمليات | شهر 8-10 | نظام مراقبة |
| 4 | إجراء تدقيق داخلي | فريق الامتثال | شهر 10-12 | تقرير التدقيق |

### المرحلة 3: التحسين (12-24 شهر)
| # | النشاط | المسؤول | الموعد | المخرج |
|---|--------|---------|--------|--------|
| 1 | تحسين العمليات | فريق الجودة | شهر 12-15 | عمليات محسنة |
| 2 | أتمتة الضوابط | الفريق التقني | شهر 15-18 | ضوابط آلية |
| 3 | توسيع نطاق التغطية | فريق المشروع | شهر 18-21 | تغطية شاملة |
| 4 | التحضير للشهادات | فريق الامتثال | شهر 21-24 | جاهزية للشهادة |
...
### جدول المؤشرات:
| # | المؤشر | الوصف | القيمة الحالية | القيمة المستهدفة | الإطار الزمني |
|---|--------|-------|---------------|-----------------|---------------|
| 1 | تغطية الضوابط | نسبة الضوابط المطبقة | يُحدد لاحقاً | تُحدد بعد التقييم | 12 شهر |
| 2 | إتمام التدريب | نسبة الموظفين المدربين | يُحدد لاحقاً | تُحدد بعد التقييم | 6 أشهر |
| 3 | معالجة المخاطر | نسبة المخاطر المعالجة | يُحدد لاحقاً | تُحدد بعد التقييم | 12 شهر |
| 4 | زمن الاستجابة | متوسط وقت الاستجابة للحوادث | يُحدد لاحقاً | تُحدد بعد التقييم | 6 أشهر |
| 5 | تحديث السياسات | نسبة السياسات المحدثة | يُحدد لاحقاً | تُحدد بعد التقييم | 9 أشهر |
| 6 | اختبارات الاختراق | عدد الاختبارات المنفذة | يُحدد لاحقاً | تُحدد بعد التقييم | 12 شهر |
| 7 | الامتثال التنظيمي | مستوى الامتثال للأطر | يُحدد لاحقاً | تُحدد بعد التقييم | 12 شهر |
| 8 | رضا أصحاب المصلحة | مؤشر رضا المستفيدين | يُحدد لاحقاً | تُحدد بعد التقييم | 12 شهر |

### دليل تقييم المؤشر رقم 1: تغطية الضوابط
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | تحديد قائمة الضوابط المطلوبة | فريق الامتثال | قائمة الضوابط |
| 2 | جرد الضوابط المطبقة حالياً | الفريق التقني | تقرير الجرد |
| 3 | مقارنة الوضع الحالي بالمطلوب | فريق التحليل | تقرير الفجوات |
| 4 | حساب نسبة التغطية | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 2: إتمام التدريب
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | تحديد الفئات المستهدفة | الموارد البشرية | قائمة الموظفين |
| 2 | متابعة سجلات التدريب | فريق التدريب | سجل الحضور |
| 3 | التحقق من إتمام المتطلبات | فريق الجودة | تقرير الإتمام |
| 4 | حساب نسبة الإتمام | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 3: معالجة المخاطر
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | مراجعة سجل المخاطر | فريق المخاطر | تقرير المراجعة |
| 2 | تحديد المخاطر المعالجة | فريق المتابعة | قائمة محدثة |
| 3 | التحقق من فعالية المعالجة | فريق التدقيق | تقرير التحقق |
| 4 | حساب نسبة المعالجة | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 4: زمن الاستجابة
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | جمع بيانات الحوادث | فريق الاستجابة | سجل الحوادث |
| 2 | حساب أوقات الاستجابة | فريق التحليل | تقرير الأوقات |
| 3 | تحليل الاتجاهات | فريق الجودة | تقرير التحليل |
| 4 | حساب المتوسط | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 5: تحديث السياسات
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | جرد السياسات الحالية | فريق الحوكمة | قائمة السياسات |
| 2 | تحديد السياسات المحدثة | فريق المراجعة | تقرير التحديث |
| 3 | التحقق من الاعتماد | فريق الجودة | سجل الاعتماد |
| 4 | حساب نسبة التحديث | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 6: اختبارات الاختراق
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | مراجعة خطة الاختبارات | فريق الأمن | خطة الاختبار |
| 2 | توثيق الاختبارات المنفذة | فريق الاختبار | تقارير الاختبار |
| 3 | تحليل النتائج | فريق التحليل | تقرير النتائج |
| 4 | حساب العدد الإجمالي | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 7: الامتثال التنظيمي
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | تحديد متطلبات الأطر | فريق الامتثال | قائمة المتطلبات |
| 2 | تقييم مستوى الامتثال | فريق التدقيق | تقرير التقييم |
| 3 | توثيق الفجوات | فريق التحليل | تقرير الفجوات |
| 4 | تحديد مستوى الامتثال | فريق القياس | قيمة المؤشر |

### دليل تقييم المؤشر رقم 8: رضا أصحاب المصلحة
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | تصميم استبيان الرضا | فريق الجودة | نموذج الاستبيان |
| 2 | جمع الردود | فريق التواصل | بيانات الردود |
| 3 | تحليل النتائج | فريق التحليل | تقرير التحليل |
| 4 | حساب مؤشر الرضا | فريق القياس | قيمة المؤشر |

[SECTION]

## 6. تقييم الجاهزية والمخاطر

### مستوى الجاهزية للتنفيذ:
يعتمد نجاح تنفيذ هذه الاستراتيجية على توفر عدة عوامل أساسية. سيتم إجراء تقييم ميداني شامل لتحديد مستوى الجاهزية الفعلي بناءً على المعايير التالية:

### عوامل النجاح الحرجة:
| # | العامل | الأهمية | الوضع الحالي |
|---|--------|---------|-------------|
| 1 | الدعم التنفيذي والقيادي | حرج | يحتاج تقييم |
| 2 | توفر الموارد المالية | عالية | يحتاج تقييم |
| 3 | الكفاءات البشرية المتخصصة | عالية | يحتاج تقييم |
| 4 | نضج البنية التحتية | متوسطة | يحتاج تقييم |
| 5 | ثقافة المنظمة وقبول التغيير | متوسطة | يحتاج تقييم |

### المخاطر الرئيسية:
| # | الخطر | الاحتمالية | الأثر | استراتيجية التخفيف |
|---|-------|-----------|-------|-------------------|
| 1 | نقص الموارد المالية | متوسطة | عالي | تحديد أولويات المشاريع وتوزيع الميزانية |
| 2 | مقاومة التغيير | متوسطة | متوسط | برامج توعية وإشراك الموظفين |
| 3 | نقص الكفاءات المتخصصة | عالية | عالي | التدريب والاستعانة بخبراء خارجيين |
| 4 | تأخر تنفيذ المشاريع | متوسطة | متوسط | متابعة دورية وإدارة فعالة للمشاريع |
...
⚠️⚠️⚠️ FRAMEWORK RESTRICTION - VERY IMPORTANT ⚠️⚠️⚠️
The user has selected these specific frameworks: {frameworks_list}
You MUST ONLY reference and cite the frameworks listed above.
Do NOT mention ISO, NIST, COBIT, or any other framework unless it is explicitly listed in the selected frameworks.
If the user selected "NCA ECC", do not mention "ISO 27001" unless ISO 27001 was also selected.
This is critical for document accuracy and compliance purposes.
...
4. ⚠️ NEVER assume or fabricate current organizational values, scores, or percentages. Current values MUST be "To be assessed by organization" or "Requires baseline assessment". Only TARGET values may be specified, and each MUST be justified with a clear rationale based on the selected frameworks or industry best practices.
5. Every percentage, score, or numeric value you produce must be supported by a clear reference to the SELECTED frameworks above (not arbitrary frameworks).
...
- **Selected Frameworks (USE ONLY THESE): {frameworks_list}**
...
| # | Gap | Description | Priority | Status |
|---|-----|-------------|----------|--------|
| 1 | [Gap name] | [Detailed description] | High | To Be Assessed |


### Detailed Implementation Guidelines:

⚠️ CRITICAL: You MUST provide a SEPARATE, COMPLETE implementation guide for EACH gap identified above. Do NOT write "repeat" or "same as above" - write the ACTUAL steps for each gap.

---
#### Gap #1 Implementation Guide: [First Gap Name]
| Phase | Step | Description | Owner | Deliverable |
|-------|------|-------------|-------|-------------|
| Planning | 1.1 | [Specific step for Gap 1] | [Team] | [Output] |
| Planning | 1.2 | [Specific step for Gap 1] | [Team] | [Output] |
| Execution | 2.1 | [Specific step for Gap 1] | [Team] | [Output] |
| Execution | 2.2 | [Specific step for Gap 1] | [Team] | [Output] |
| Verification | 3.1 | [Specific step for Gap 1] | [Team] | [Output] |
...
| 2 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |
| 3 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |
| 4 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |
| 5 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |
| 6 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |
| 7 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |
| 8 | [KPI Name] | [Brief description] | To be assessed | [Justified value] | [Why this target] | Within X months | [Source] |

### KPI Assessment Guidelines

Provide step-by-step guides for measuring each KPI's current value:

---
#### KPI #1 Assessment Guide: [First KPI Name]
| Step | Action | Owner | Output |
|------|--------|-------|--------|
| 1 | Define measurement scope | [Team] | Scope document |
| 2 | Identify data sources | [Team] | Data sources list |
| 3 | Collect baseline data | [Team] | Raw data |
| 4 | Validate data accuracy | [Team] | Validated data |
| 5 | Calculate current value | [Team] | KPI value |
...
You MUST include SEPARATE, COMPLETE implementation guides for Gap #1, Gap #2, Gap #3, Gap #4, and Gap #5.
Do NOT write "repeat for each gap" or "same steps as above" - write the ACTUAL implementation table for EACH gap individually.
Without separate implementation guides for each gap, the document is INCOMPLETE and REJECTED."""
...
| الخطوة | الإجراء | المسؤول | المخرج |
|--------|--------|---------|--------|
| 1 | تحديد نطاق القياس وحدوده | فريق القياس | وثيقة النطاق |
| 2 | تحديد مصادر البيانات المتاحة | فريق القياس | قائمة المصادر |
| 3 | جمع البيانات الأساسية | فريق القياس | البيانات الخام |
| 4 | التحقق من دقة البيانات وصحتها | ضمان الجودة | بيانات موثقة |
| 5 | حساب القيمة الحالية للمؤشر | فريق القياس | قيمة المؤشر |
...
| Step | Action | Owner | Output |
|------|--------|-------|--------|
| 1 | Define measurement scope and boundaries | Measurement Team | Scope document |
| 2 | Identify available data sources | Measurement Team | Data sources list |
| 3 | Collect baseline data | Measurement Team | Raw data |
| 4 | Validate data accuracy | QA | Validated data |
| 5 | Calculate current KPI value | Measurement Team | KPI value |
...
| # | الضابط | الأولوية | الجدول الزمني | التكلفة المقدرة | الحالة |
|---|--------|----------|---------------|-----------------|--------|
| 1 | [اسم الضابط] | عالية | فوري | [التكلفة] | يحتاج تقييم |
| 2 | [اسم الضابط] | عالية | خلال 30 يوم | [التكلفة] | يحتاج تقييم |
| 3 | [اسم الضابط] | متوسطة | خلال 60 يوم | [التكلفة] | يحتاج تقييم |

### دليل تنفيذ الضوابط:

⚠️ مهم جداً: لكل ضابط موصى به، قدم دليل تنفيذ خطوة بخطوة:
...
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التحضير | 1.1 | [وصف الخطوة] | [الفريق] | [المخرج] |
| التنفيذ | 2.1 | [وصف الخطوة] | [الفريق] | [المخرج] |
| التحقق | 3.1 | [وصف الخطوة] | [الفريق] | [المخرج] |
(6-10 خطوات لكل ضابط)
...
**مكونات الدرجة:**
| العامل | الوزن | الدرجة | المبرر |
|--------|-------|--------|--------|
| جودة معلومات التهديدات | 25% | [X/10] | [تقييم مصادر بيانات التهديدات] |
| دقة تقييم الأصول | 20% | [X/10] | [الثقة في تقديرات قيمة الأصول] |
| تقييم الثغرات | 20% | [X/10] | [جودة بيانات الثغرات] |
| فعالية الضوابط | 20% | [X/10] | [الثقة في تقييمات الضوابط] |
| البيانات التاريخية | 15% | [X/10] | [توفر سجل الحوادث] |

**تفسير مستوى الثقة:**
- 90-100%: ثقة عالية - تقييم المخاطر مدعوم بالبيانات
- 70-89%: ثقة متوسطة - التقييم دقيق على الأرجح
- 50-69%: ثقة محدودة - يوصى بتحليل إضافي
- أقل من 50%: ثقة منخفضة - تقييم أولي يحتاج تحقيق
...
| # | Control | Priority | Timeline | Estimated Cost | Status |
|---|---------|----------|----------|----------------|--------|
| 1 | [Control name] | High | Immediate | [Cost] | To Be Assessed |
| 2 | [Control name] | High | Within 30 days | [Cost] | To Be Assessed |
| 3 | [Control name] | Medium | Within 60 days | [Cost] | To Be Assessed |

### Control Implementation Guidelines:

⚠️ CRITICAL: For each recommended control, provide step-by-step implementation guide:
...
|--------|--------|-------|---------------|
| Threat Intelligence Quality | 25% | [X/10] | [Assessment of threat data sources] |
| Asset Valuation Accuracy | 20% | [X/10] | [Confidence in asset value estimates] |
| Vulnerability Assessment | 20% | [X/10] | [Quality of vulnerability data] |
| Control Effectiveness | 20% | [X/10] | [Confidence in control ratings] |
| Historical Data | 15% | [X/10] | [Availability of incident history] |

**Confidence Level Interpretation:**
- 90-100%: High confidence - risk assessment is well-supported by data
- 70-89%: Moderate confidence - assessment likely accurate, some assumptions made
- 50-69%: Limited confidence - significant assumptions, recommend additional analysis
- Below 50%: Low confidence - preliminary assessment, further investigation needed
...
⚠️⚠️⚠️ FRAMEWORK RESTRICTION - CRITICAL ⚠️⚠️⚠️
The selected framework for this audit is: {framework}
You MUST ONLY reference and cite this framework and its specific controls.
Do NOT mention ISO, NIST, COBIT, or any other framework unless it is the selected framework above.
All control references, compliance assessments, and recommendations must be specific to {framework}.
...
6. CRITICAL: Every finding must include "To Be Assessed" status and detailed implementation guidelines
7. Reference ONLY the {framework} controls - do not cite other frameworks
...
| # | Observation | Affected Control | Recommendation | Status |
|---|-------------|-----------------|----------------|--------|
| 1 | [First high-risk finding] | [Control ID] | [Action] | To Be Assessed |
| 2 | [Second high-risk finding] | [Control ID] | [Action] | To Be Assessed |

### Medium-Risk Findings
| # | Observation | Affected Control | Recommendation | Status |
|---|-------------|-----------------|----------------|--------|
| 1 | [First medium-risk finding] | [Control ID] | [Action] | To Be Assessed |
| 2 | [Second medium-risk finding] | [Control ID] | [Action] | To Be Assessed |
...
⚠️ CRITICAL: You MUST provide SEPARATE implementation guides for Finding #1, Finding #2, Finding #3, etc. Do NOT write "repeat" - write actual steps for each.
...
| Domain | Compliance Rate | Assessment |
|--------|----------------|------------|
| Governance | To be determined | Requires review |
| Risk Management | To be determined | Requires review |
| Technical Controls | To be determined | Requires review |
| Awareness & Training | To be determined | Requires review |
...
**Confidence Level:** To be determined after field assessment

**Key Factors:**
| Factor | Importance | Status |
|--------|------------|--------|
| Evidence Quality | High | To be assessed |
| Testing Coverage | High | To be assessed |
| Documentation | Medium | To be assessed |
| Interview Reliability | Medium | To be assessed |
...
You MUST include SEPARATE implementation guides for each High-Risk and Medium-Risk finding.
Do NOT write "repeat for each finding" - write the ACTUAL implementation table for EACH finding.
Do NOT use any specific percentages like 75%, 80%, etc. Use "To be determined" instead."""

        if lang == 'ar':
            prompt = f"""أنشئ تقرير تدقيق احترافي لإطار {framework} في مجال {domain}.
...
# تقرير التدقيق - {framework}

## الملخص التنفيذي
يقدم هذا التقرير نتائج تدقيق الامتثال لإطار {framework}. تم تحديد عدة ملاحظات تتطلب معالجة لتحسين مستوى الامتثال. سيتم تحديد نسبة الامتثال الفعلية بعد استكمال التقييم الميداني.

## نطاق التدقيق
- مراجعة الضوابط الأساسية وفق إطار {framework}
- تقييم السياسات والإجراءات المعتمدة
- فحص البنية التحتية التقنية والأمنية
- مراجعة سجلات الوصول والصلاحيات
- تقييم برامج التوعية والتدريب

## منهجية التدقيق
1. مراجعة الوثائق والسياسات المعتمدة
2. إجراء مقابلات مع المسؤولين الرئيسيين
3. فحص البنية التحتية التقنية
4. اختبار الضوابط الأمنية
5. تحليل السجلات والتقارير
...
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | عدم وجود سياسة تصنيف البيانات معتمدة | (رمز الضابط) | تطوير واعتماد سياسة شاملة | يحتاج تقييم |
| 2 | ضعف في إدارة التصحيحات الأمنية | (رمز الضابط) | تطبيق آلية منتظمة للتحديثات | يحتاج تقييم |

### نتائج متوسطة الخطورة
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | نقص في برامج التوعية الأمنية | (رمز الضابط) | تعزيز برنامج التدريب | يحتاج تقييم |
| 2 | عدم تحديث سياسات الصلاحيات | (رمز الضابط) | مراجعة دورية للصلاحيات | يحتاج تقييم |

### نتائج منخفضة الخطورة
| # | الملاحظة | الضابط المتأثر | التوصية | الحالة |
|---|----------|---------------|---------|--------|
| 1 | تحسينات مطلوبة في التوثيق | (رمز الضابط) | تحديث الوثائق الفنية | يحتاج تقييم |

## أدلة التنفيذ التفصيلية

### دليل تنفيذ الملاحظة عالية الخطورة رقم 1
**الضابط المتأثر:** (رمز الضابط)
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | تحليل متطلبات التصنيف | فريق الحوكمة | تقرير التحليل |
| التخطيط | 1.2 | صياغة مسودة السياسة | فريق السياسات | مسودة السياسة |
| التنفيذ | 2.1 | مراجعة واعتماد السياسة | الإدارة العليا | سياسة معتمدة |
| التنفيذ | 2.2 | نشر وتدريب الموظفين | فريق التدريب | سجلات التدريب |
| التحقق | 3.1 | التحقق من التطبيق | فريق الامتثال | تقرير التحقق |
**الأدلة المطلوبة:** ☐ السياسة المعتمدة ☐ سجلات التدريب ☐ تقرير الامتثال

### دليل تنفيذ الملاحظة عالية الخطورة رقم 2
**الضابط المتأثر:** (رمز الضابط)
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | جرد الأنظمة والبرمجيات | الفريق التقني | قائمة الأصول |
| التخطيط | 1.2 | وضع جدول التحديثات | فريق العمليات | جدول معتمد |
| التنفيذ | 2.1 | تنفيذ التحديثات الدورية | الفريق التقني | سجل التحديثات |
| التنفيذ | 2.2 | اختبار التوافق | فريق الاختبار | تقرير الاختبار |
| التحقق | 3.1 | التحقق من اكتمال التحديثات | فريق الامتثال | تقرير التحقق |
**الأدلة المطلوبة:** ☐ سجل التحديثات ☐ تقارير الاختبار ☐ تقرير الامتثال

### دليل تنفيذ الملاحظة متوسطة الخطورة رقم 1
**الضابط المتأثر:** (رمز الضابط)
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | تقييم مستوى الوعي الحالي | فريق التدريب | تقرير التقييم |
| التنفيذ | 2.1 | تطوير محتوى تدريبي | فريق التدريب | مواد تدريبية |
| التنفيذ | 2.2 | تنفيذ برنامج التوعية | فريق التدريب | سجلات الحضور |
| التحقق | 3.1 | قياس فعالية التدريب | فريق الجودة | تقرير الفعالية |
**الأدلة المطلوبة:** ☐ المواد التدريبية ☐ سجلات الحضور ☐ نتائج الاختبارات

### دليل تنفيذ الملاحظة متوسطة الخطورة رقم 2
**الضابط المتأثر:** (رمز الضابط)
| المرحلة | الخطوة | الوصف | المسؤول | المخرجات |
|---------|--------|-------|---------|----------|
| التخطيط | 1.1 | مراجعة الصلاحيات الحالية | فريق الأمن | تقرير المراجعة |
| التنفيذ | 2.1 | تحديث مصفوفة الصلاحيات | فريق الأمن | مصفوفة محدثة |
| التنفيذ | 2.2 | تطبيق التغييرات | الفريق التقني | سجل التغييرات |
| التحقق | 3.1 | التحقق من الصلاحيات | فريق التدقيق | تقرير التحقق |
**الأدلة المطلوبة:** ☐ مصفوفة الصلاحيات ☐ سجل التغييرات ☐ تقرير التدقيق

## تقييم الامتثال
| المجال | نسبة الامتثال | التقييم |
|--------|--------------|---------|
| الحوكمة والقيادة | يُحدد بعد التقييم | يحتاج مراجعة |
| إدارة المخاطر | يُحدد بعد التقييم | يحتاج مراجعة |
| الضوابط التقنية | يُحدد بعد التقييم | يحتاج مراجعة |
| التوعية والتدريب | يُحدد بعد التقييم | يحتاج مراجعة |
...
## مستوى الثقة في نتائج التدقيق

### عوامل تقييم الثقة:
| العامل | الوزن | التقييم | الملاحظات |
|--------|-------|---------|----------|
| جودة الأدلة المقدمة | عالي | يحتاج تقييم | يعتمد على توفر الوثائق |
| تغطية نطاق التدقيق | عالي | يحتاج تقييم | يعتمد على شمولية الفحص |
| تعاون الجهات المعنية | متوسط | يحتاج تقييم | يعتمد على الاستجابة |
| دقة المعلومات | عالي | يحتاج تقييم | يعتمد على التحقق |

**ملاحظة:** سيتم تحديد مستوى الثقة النهائي بعد استكمال جميع إجراءات التدقيق والتحقق من الأدلة.
