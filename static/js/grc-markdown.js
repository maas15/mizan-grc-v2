      ...
      function renderTable(tableLines, inheritedHeader){
        ...
        tableLines.forEach(function(tl){
          ...
          if(isRaci7Pre && rowIdx2 > 0){
            // AI sometimes prefixes a row-counter digit before the Activity text:
            //   | 1 | Establish Dept | HR Director | ... |  → headerCols+1 cells
            // Drop it so Activity lands in column 0.
            if(cells.length === headerCols + 1 && /^\d+$/.test(cells[0])){
